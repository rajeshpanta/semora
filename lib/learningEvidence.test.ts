...
/**
 * THE CASE TABLE. This is the contract, and it is duplicated verbatim in
 * supabase/functions/tutor-chat/learningEvidence.test.ts because the client
 * and the edge function cannot share a module across the RN/Deno boundary.
 * If a row changes here it MUST change there — that is the only thing keeping
