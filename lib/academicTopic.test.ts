...
import { academicDescription, isAcademicTopic } from '@/lib/academicTopic';

/**
 * THE CASE TABLE. Duplicated verbatim in
 * supabase/functions/tutor-chat/academicTopic.test.ts because the client and
