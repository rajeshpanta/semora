...
const OPENAI_MODEL = Deno.env.get('TUTOR_OPENAI_MODEL')?.trim() || 'gpt-5.6-terra'; // mid tier: $2/$12 per 1M vs luna $0.20/$1.20 — better quality at ~10x cost; per-user quotas bound the spend
