...
const COPY = {
  en: {
    ...
    scanNote: 'Point your phone camera at the code.',
    scanPoints: [
      'Works on iPhone, iPad and any browser',
      'Everything syncs to the same semester',
      'Pro applies to the account, not the device',
    ] as const,
  ...
  es: {
    ...
    scanNote: 'Apunta la cámara de tu teléfono al código.',
    scanPoints: [
      'Funciona en iPhone, iPad y cualquier navegador',
      'Todo se sincroniza en el mismo semestre',
      'Pro se aplica a la cuenta, no al dispositivo',
    ] as const,
    web: 'Abrir en el navegador',
    ready: (n: number) => `${n} plataformas listas hoy`,
