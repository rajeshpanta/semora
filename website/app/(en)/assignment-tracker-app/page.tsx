...
const KEY = 'assignment-tracker-app' as const;
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    alternates: enAlternates('/assignment-tracker-app'),
    openGraph: { url: '/assignment-tracker-app', ...OG_IMAGE },
  };
}
