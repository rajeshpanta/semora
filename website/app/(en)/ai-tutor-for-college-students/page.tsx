...
const KEY = 'ai-tutor-for-college-students' as const;
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    alternates: enAlternates('/ai-tutor-for-college-students'),
    openGraph: { url: '/ai-tutor-for-college-students', ...OG_IMAGE },
  };
}
...
export default function Page() {
  ...
  return (
    <LongFormPage
      path="/ai-tutor-for-college-students"
      content={content}
