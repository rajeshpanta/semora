...
const KEY = 'mindgrasp-alternative' as const;
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    alternates: enAlternates('/mindgrasp-alternative'),
    openGraph: { url: '/mindgrasp-alternative', ...OG_IMAGE },
  };
}
