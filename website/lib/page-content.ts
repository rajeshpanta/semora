  ...
  "home": {
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          "Free: 1 AI action for the life of the account, unlimited classes synced free from Canvas plus one course you add by hand within one semester, one semester total",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Two boundaries get misreported often enough to be worth stating directly. First, Blackboard and Moodle import is Pro, while Canvas import is free, not free. It is gated on the server, so the paywall is not a client-side suggestion. The free route into Canvas is real and worth using: open the assignments page, select the text, and paste it into the scanner's paste box on the web app, which accepts 20 to 60,000 characters. You get the same extraction and the same review screen. It costs one AI action and nothing else.",
  ...
  "compare": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Semora is an intake and organizing tool with a studying layer on top, in that order. The deadline and grade tracking are the core and they are free, and the scanner that feeds them gives every free account one AI action to spend. The planning and study features — Smart Plan, the Workload dashboard, Flashcards, the Focus timer, the AI Tutor, Grade Scale and Forecasting, calendar sync, custom reminder timing with quiet hours, Academic Risk alerts, Progress Insights, hosting a Course Space, and Canvas, Blackboard, or Moodle import — are Pro. That split is deliberate: the facts about your semester should not be behind a paywall, and you should be able to test whether the extraction is any good on your own syllabus before deciding anything.",
  ...
  "blog": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No. Connecting Blackboard or Moodle is part of Pro, while Canvas is free at $3.99 a month or $19.99 a year, and the server enforces it rather than the app merely hiding a button. The free-tier route is real, though, and the Canvas post covers it: copy your assignment list as text and paste it straight into the syllabus scanner, which accepts pasted text on the web from twenty up to sixty thousand characters."
      },
      {
