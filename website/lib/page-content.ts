    ...
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          ...
          "Free includes deadlines, tasks, weighted grade tracking and advance reminders in full",
  ...
  "features": {
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          "Free: scanning, 4 courses, unlimited deadlines and tasks, weighted grade tracking and semester GPA, advance reminders, Today and Calendar, and joining a Course Space.",
          ...
          "Pro connections: Canvas, Blackboard and Moodle import, hosting Course Spaces, device calendar sync with .ics export, and per-task custom reminder timing with quiet hours."
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Semora is one universal iOS app covering iPhone and iPad, plus a web app, on one account, syncing in near real time. There is no Android app and no Mac app. Pro is purchased in the iOS app through StoreKit and applies account-wide, including on the web, where the app reads and refreshes the entitlement rather than running its own checkout. Scheduled reminders are native-app notifications. Courses and tasks created or edited without a connection are queued locally, retried with backoff, and checked against the server version so a conflicting edit surfaces rather than silently overwriting."
        ]
      },
      {
  ...
  "support": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "If permission is fine and reminders still do not arrive, work through the specifics. A reminder whose fire time has already passed is never scheduled, so a task added a couple of hours before it is due can end up with only the alert at the deadline itself. Free accounts get the standard reminder set, and the timing follows the task: for a task with a due time, the same-day alert fires at the deadline itself, and for an all-day task it fires at 9 AM. On top of that comes a last call, two hours before a timed deadline, or 7 PM for an all-day task. So a paper due at 11:59 PM is nudged at 9:59 PM and again at 11:59 PM; there is no separate morning alert unless the task has no due time. The per-task custom reminder timing are Pro, and so is custom reminder timing with quiet hours; with quiet hours on, a reminder that would land inside the window is pushed to the end of it rather than dropped.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No. Free accounts get the standard reminder set: for a task with a due time the same-day alert fires at the deadline itself, for an all-day task at 9 AM, plus a last call two hours before a timed deadline or at 7 PM for an all-day task. A paper due at 11:59 PM therefore gets 9:59 PM and 11:59 PM, not a morning ping. The per-task custom reminder timing and quiet hours are Pro. When you upgrade, Semora reschedules reminders for every incomplete task you already have, so existing deadlines pick up the earlier alerts without you editing them one by one."
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Everything you accept on the review screen becomes an ordinary task attached to the course, carrying its type, due date, due time, and percentage weight. That is why one scan gives you both a deadline list and working weighted grade tracking: the weights came out of the same pass, and weighted averages and semester GPA are free. Advance reminders are free too. Device calendar sync and .ics export are Pro, as is per-task custom reminder timing, with quiet hours. Calendar sync writes to the calendar on your device, so it is an app feature rather than something the browser can do."
        ]
      },
      {
  ...
  "ai-study-planner-for-college": {
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          "Free: 5 syllabus scans per calendar month, up to 4 courses, and one semester per account. Full deadline and task tracking, grade tracking with weighted averages, semester GPA, advance reminders, and joining any Course Space a classmate invites you into.",
          "Pro adds the planning layer: Smart Plan, the Workload dashboard, unlimited courses and semesters, syllabus scanning with no monthly cap (a fair-use ceiling of 20 scans in a day), per-task custom reminder timing with quiet hours, device calendar sync with .ics export, Canvas, Blackboard and Moodle import, hosting your own Course Space, Flashcards, the Focus timer, the AI Tutor, Grade Scale and Forecasting, Academic Risk alerts, Progress Insights, and Share and Streaks."
        ]
      }
    ],
    "faq": [
