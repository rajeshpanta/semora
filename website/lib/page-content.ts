    ...
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          ...
          "Canvas, Blackboard and Moodle import is optional, free, and subject to your institution's policy",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Two boundaries get misreported often enough to be worth stating directly. First, connecting a learning platform — Canvas, Blackboard or Moodle — is free on every plan. What decides whether it works is your school's policy, not ours. And the paste route stays useful for anything Canvas does not carry: open the assignments page, select the text, and paste it into the scanner's paste box on the web app, which accepts 20 to 60,000 characters. You get the same extraction and the same review screen. It costs one AI action and nothing else.",
