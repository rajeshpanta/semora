    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Pro is $3.99 a month or $19.99 a year, which works out to about $1.67 a month annually. You can buy it with a card on the web at app.semoraai.com, where Stripe handles the payment, or inside the iOS app through the App Store, and either way the entitlement applies to your whole account, including the web app \u2014 there is no version of Semora you have to buy twice."
        ],
        "bullets": [
  ...
  "features": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Pricing is $3.99 a month or $19.99 a year, which works out to about $1.67 a month and roughly 58 percent less than paying monthly. The purchase happens either on the web at app.semoraai.com, where Stripe takes the card, or inside the iOS app through the App Store, and the entitlement applies to your whole account whichever route you took. There is nothing to activate on the other surface beyond signing in with the same email."
        ],
        "bullets": [
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "$3.99 a month or $19.99 a year, which is about $1.67 a month on the annual plan. You can buy it by card on the web, where Stripe handles the billing and you manage the plan from Settings inside Semora, or in the app through the App Store, where it is managed through your Apple ID. Either way it applies to your whole account."
      }
    ]
  },
  "pricing": {
  ...
  "support": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Pro is bought once — $3.99 a month or $19.99 a year, which works out to about $1.67 a month on the annual plan — either by card on the web, where Stripe handles the checkout, or in the iOS app through Apple. What the purchase produces is a server-side entitlement attached to your account, and every surface reads that same record, which is why Pro applies account-wide, including in the browser, without a second payment.",
  ...
  "ai-syllabus-scanner": {
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          ...
          "Pro, $3.99/month or $19.99/year: no scan cap, unlimited courses and semesters",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "One course you add by hand, inside a single semester, plus as many Canvas-synced classes as you take. The semester limit is one per free account in total, not one per term, so a free account cannot start a second semester later — a scan that resolves to a new term stops before anything is written and offers the upgrade instead. Pro ($3.99 a month, or $19.99 a year) removes both limits along with the one-action cap. Deadline and task tracking, weighted grade averages, semester GPA, same-day reminders, and joining a Course Space a classmate invites you to are all included free."
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Pro is $3.99 a month or $19.99 a year, which works out to about $1.67 a month and is roughly 58% cheaper annually. You buy it either by card on the web, where Stripe handles the checkout, or inside the iOS app through the App Store, and the entitlement applies to your whole account, so every surface reads the same Pro status."
        ],
        "bullets": [
