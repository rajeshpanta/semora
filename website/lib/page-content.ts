  ...
  "compare": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Semora is an intake and organizing tool with a studying layer on top, in that order. The deadline and grade tracking are the core and they are free, and the scanner that feeds them gives every free account one AI action to spend. The planning and study features — Smart Plan, the Workload dashboard, Flashcards, the Focus timer, the AI Tutor, Grade Scale and Forecasting, calendar sync, custom reminder timing with quiet hours, Academic Risk alerts, Progress Insights, and hosting a Course Space — are Pro. That split is deliberate: the facts about your semester should not be behind a paywall, and you should be able to test whether the extraction is any good on your own syllabus before deciding anything.",
