...
export const PAGE_CONTENT: Partial<Record<PageKey, PageLongForm>> =
{
  "home": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "The free tier is not a trial that expires. It is one AI action for the lifetime of the account — a syllabus scan, a lecture recording, or a document turned into notes, whichever you reach for first — plus unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand within one semester, and one semester in total. Inside those limits you get the whole organizing layer: full deadline and task tracking, grade tracking with weighted averages, same-day reminders, and the ability to join a Course Space a classmate invites you to.",
          "The two limits worth understanding before you start are the course cap and the semester cap, and they work differently. The course cap counts only what you add yourself — one course, within a single term — while classes that arrive from Canvas are exempt from it entirely, however many you take. One semester is a harder line: a free account cannot start a second term at all, so the cap is not something that quietly rolls over in January. Pro removes both, along with the one-AI-action limit.",
          "Pro is $4.99 a month or $29.99 a year, which works out to about $2.50 a month annually. You can buy it with a card on the web at app.semoraai.com, where Stripe handles the payment, or inside the iOS app through the App Store, and either way the entitlement applies to your whole account, including the web app \u2014 there is no version of Semora you have to buy twice."
        ],
        "bullets": [
          "Free: 1 AI action for the life of the account, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand within one semester, one semester total",
          "Free includes deadlines, tasks, weighted grade tracking and same-day reminders in full",
          "Pro ($4.99/month or $29.99/year) removes all three caps and adds the planning and study tools",
          "Pro is bought on the web or in the app, and applies account-wide either way"
        ]
      },
      {
      ...
      },
      {
        ...
        "bullets": [
          ...
          "Canvas and Moodle import is optional, free, and set up from a calendar link you copy yourself; Blackboard is free too, and subject to your institution's policy",
    ...
    "faq": [
      ...
      {
        "question": "Does a five-page photo scan use up more than one AI action?",
        "answer": "No. A photo scan of up to five pages counts as one scan, and one scan is one AI action. The free allowance is a single AI action for the lifetime of the account, so a stapled five-page syllabus is exactly the kind of thing worth spending it on."
      },
      {
  ...
  "features": {
    "sections": [
      ...
      {
        "heading": "What one AI action and one hand-added course actually cover",
        "paragraphs": [
          "The free tier is one AI action for the lifetime of the account, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, and one semester for the account. The three numbers are not enforced identically, and the difference is worth a sentence. The AI-action limit is checked in three places: in the app, in the parsing function on the server before any paid extraction runs, and again by a database trigger. The course limit and the semester limit are checked in two: in the app, and by a BEFORE INSERT trigger on the database. Either way they behave the same on iPhone, iPad and the web app, and none of them can be talked around by a client that decides to skip a check.",
          "Run the week-one math. A standard full-time load in the US is four or five courses, and free covers one AI action, so the honest version is that free shows you the extraction on the course you care most about rather than setting the whole term up for you. Spend it where it saves the most: the syllabus you least want to retype, the lecture you most want written down, or the document you most want turned into notes. The counter is a lifetime one and nothing resets it, so a syllabus your professor revises in October is a Pro job rather than a free one. Where free is generous is the other direction: photo scans are counted per submission, so five pages captured in a single pass is one action, not five.",
          "AI actions and courses are separate limits, and knowing that saves you money. Re-scanning a syllabus for a course you already have merges into that existing course (matched by course code, or by exact name when the syllabus has no code) so it costs an action but not a course slot. What that merge will not do is overwrite the schedule: the deadlines come through, the meeting times stay as you left them, and the grading scale is only refreshed if it is still the untouched default. Courses you type in yourself cost no AI action at all, and the course you add yourself is counted the same way whether it arrives by scan, by hand, or by joining the Course Space a classmate is hosting. Classes synced from Canvas are the exception: they are never counted against it.",
          "One more limit belongs on an honest map, and it is the one people meet late: a free account gets one semester, total. Not one live at a time with a fresh one each term, one. That is why the one manual course you get does not refresh in January; on free there is no second semester to start. Classes synced from Canvas are the exception that makes this liveable — they are free, unlimited, and never counted. Deleting the finished semester from the Courses tab is the only way to free the slot, and the delete cascades: that semester's courses, deadlines, grades and history go with it, and nothing is archived. If you want last spring still readable next spring, that is what unlimited semesters on Pro are for."
        ],
        "bullets": [
          "1 AI action for the lifetime of the account — a syllabus scan, a lecture recording or a document turned into notes. Five photographed pages in one submission counts as one.",
          "One course you add by hand — for the account, not per term, because free is one semester. Classes synced from Canvas are unlimited and never counted, so a full course load still fits when it comes from Canvas.",
          "Re-scanning a course you already have merges into it: an AI action spent, a course slot kept, your schedule edits untouched.",
          ...
          "One semester total on free; unlimited semesters and courses on Pro, with no cap on scanning."
        ]
      },
      {
        "heading": "Where the Pro line actually falls",
        "paragraphs": [
          "The clean way to describe the split: free is enough to know what is due and where you stand. Pro is for deciding what to do about it, plus the connective tissue to other platforms, other people and other calendars. Nothing in the free tier expires or quietly degrades — your free AI action sits there until you decide what to spend it on, and the free features stay on for as long as you keep using the app.",
          "Two boundaries get misreported often enough to be worth stating directly. First, connecting a learning platform — Canvas, Blackboard or Moodle — is free on every plan. Moodle connects the way Canvas does, from a calendar link you copy out of Moodle yourself, with nothing for an administrator to enable. For Canvas and Blackboard, what decides whether it works is your school's policy, not ours. And the paste route stays useful for anything Canvas does not carry: open the assignments page, select the text, and paste it into the scanner's paste box on the web app, which accepts 20 to 60,000 characters. You get the same extraction and the same review screen. It costs one AI action and nothing else.",
          ...
          "Nothing is deleted if you stop paying. The free limits are checked when you add something new, so the courses, semesters, deadlines and grades you already have stay readable and editable — what changes is that Pro-only screens lock again and new additions are held to the single free AI action, the one hand-added course and the one-semester rule.",
          "Pricing is $4.99 a month or $29.99 a year, which works out to about $2.50 a month and roughly 50 percent less than paying monthly. The purchase happens either on the web at app.semoraai.com, where Stripe takes the card, or inside the iOS app through the App Store, and the entitlement applies to your whole account whichever route you took. There is nothing to activate on the other surface beyond signing in with the same email."
        ],
        "bullets": [
          "Free: one AI action to spend on a scan, a lecture or notes, unlimited classes synced from Canvas plus one course you add by hand, unlimited deadlines and tasks, weighted grade tracking and semester GPA, same-day reminders, Today and Calendar, and joining a Course Space.",
          "Pro capacity: unlimited courses, unlimited semesters, and no cap on scans — the only ceiling left is fair use, 20 scans in any rolling 24 hours, which no real semester reaches.",
          "Pro decisions: Smart Plan, Workload dashboard, Academic Risk alerts, Grade Scale & Forecasting, Progress Insights with trend charts, CSV export and a print view.",
          "Pro study tools: AI flashcards with SM-2 spaced repetition, the Focus Timer, the AI Tutor grounded in your own course.",
          "Pro connections: hosting Course Spaces, device calendar sync with .ics export, and 1-day and 3-day reminders with quiet hours."
        ]
      },
      {
        "heading": "Start with the feature that matches what is breaking",
        "paragraphs": [
          "Feature lists are a bad way to choose a starting point, because you do not have a feature problem, you have a specific thing going wrong. Match the symptom instead. Most of these take under ten minutes to set up, and the two that matter most in week one — your first scan and grade tracking — cost nothing.",
          "If the problem is that you genuinely do not know what is due, spend your free scan on the syllabus you are least sure about and stop there for the day. Today and Calendar will carry you for weeks on the free tier alone. If the problem is that you know what is due but keep starting too late, that is Smart Plan: it defaults to 90 minutes a day in 45-minute sessions, starting at 5pm on weekdays and 10am at weekends, and it reschedules around your class meetings rather than pretending your afternoons are empty. If the problem is being blindsided, that is the Workload dashboard, which shows the crunch weeks before you walk into them.",
          "If the problem is that you cannot tell whether you are actually fine in a course, start with grades: enter the scores you already have and read the weighted average. Add Grade Scale & Forecasting when you need the reverse question answered, which is what you need on what is left to land a specific letter. If the problem is that you sit down to study and lose twenty minutes deciding what to study, generate a flashcard deck scoped to one upcoming exam rather than the whole course, and run the Focus Timer against it."
        ],
        "bullets": [
          "\"I do not know what is due\" — Scan, then Today. The scan is your one free AI action.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Changes propagate over a realtime connection rather than waiting for a manual refresh. Tick something off in a lecture on your phone and the laptop tab you left open in the library updates within seconds. Bulk changes are handled sensibly too: importing a scanned syllabus writes many deadline rows at once, and those are collapsed into a single refresh instead of dozens. When an app comes back from the background, or a browser tab regains focus, or a device reconnects after losing signal, Semora re-fetches once to catch anything it missed while suspended.",
          "Losing signal does not stop you working, which is the part most planners get wrong. Creating a course or a task, editing either one, ticking a task off, checking a subtask and adjusting a grade category all go through with no connection and queue on the device. The last seven days of your data stays cached there too, so opening the app in a basement lecture hall shows your real semester rather than an empty screen. Deleting is the one action that still waits for a connection.",
          "The app itself is available in English and Spanish, not just this website — screens, reminders, the tutor and every settings label. Semora starts in Spanish if that is what the device is set to, and the first onboarding screen offers both languages before any English copy has to be understood, which is the point: a student should not have to read a wall of English to discover the app speaks Spanish. Afterwards it lives under Me, Settings, App language. The choice is stored on your account rather than on the handset, so it follows you to the iPad and to the web app, and it applies the moment you tap it rather than at the next launch.",
          "The surfaces differ where the hardware differs, and only there. Scanning on iOS uses the camera, your photo library or the Files app; the web app adds drag-and-drop onto the scan frame and pasted text, which is the fastest and most accurate path when you are on a laptop with the syllabus already open. The iPhone app is portrait; on iPad it rotates all four ways and reflows live for Split View. Wide browser windows switch to a persistent left sidebar. iOS also gets home-screen widgets for what is up next and what is due this week, and device calendar sync writes to the calendar on your phone or iPad — that one does not run in a browser, where the equivalent is the .ics export. Pro can be bought on either surface — by card on the web, or through the App Store in the app — and is read everywhere."
        ],
        "bullets": [
          ...
          "Work offline: create and edit courses and tasks, tick them off, and it all queues and flushes on its own.",
          "Web-only input paths: drag-and-drop and pasted syllabus text, 20 to 60,000 characters.",
          "iOS-only extras: home-screen widgets and device calendar sync. Buying Pro is not one of them — card on the web or the App Store in the app, and it turns Pro on account-wide either way.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes. All three share one account and one database and sync in near real time, so an edit on your phone shows up in the browser. Pro can be bought with a card on the web or inside the iOS app through the App Store, and the entitlement applies account-wide either way \u2014 you only ever pay once."
      },
      {
        "question": "How much is Pro?",
        "answer": "$4.99 a month or $29.99 a year, which is about $2.50 a month on the annual plan. You can buy it by card on the web, where Stripe handles the billing and you manage the plan from Settings inside Semora, or in the app through the App Store, where it is managed through your Apple ID. Either way it applies to your whole account."
      }
    ]
  },
  "pricing": {
    "sections": [
      {
        ...
        "paragraphs": [
          "The free tier has three ceilings, not two: how many AI actions the account ever gets, one; how many courses you can carry in a semester; and how many semesters the account can hold, one. Beyond those three, nothing on free is metered. Tasks have never been limited: you can track two hundred deadlines on a free account and nothing will stop you. Nothing on free asks for a payment method either — a card or an App Store charge only enters the picture if you decide to buy Pro.",
          "The AI limit is one action for the lifetime of the account, and nothing resets it. The same count is computed identically in the app, on the server that runs the extraction, and in the database rule that backs both up, so the number you see on the scan tab is the number the server will actually honor. It is spent when an extraction runs, which means an extraction you start and then abandon still consumes it. The app is upfront about this: when you are about to use it, it tells you before it runs, not after.",
          "The course limit counts only the courses you add yourself: one per semester, so it is the second hand-added course that gets blocked — the first is created normally. Classes synced from Canvas are exempt and uncapped, so a full four- or five-course load fits inside free when it arrives from Canvas. You hit the wall when you type a second class in by hand — a seminar Canvas does not carry, a lab tracked separately, or a course at a school whose Canvas you have not connected. The counter is scoped to the semester you are adding to rather than to the account, which sounds like it means the count starts over each term. On free, it does not work out that way, and that is worth spelling out.",
        ...
        "bullets": [
          "One AI action for the lifetime of the account — a scan, a lecture recording or a document turned into notes — with nothing that resets it",
          "The scan tab shows whether the action is still unspent, and warns you before you spend it",
          "One hand-added course per semester — the second is what gets blocked, while Canvas-synced classes are exempt and unlimited",
      ...
      },
      {
        ...
        "bullets": [
          "Unlimited courses and unlimited semesters, plus the one-action limit removed — the same scanner, minus the count",
          ...
          "Grade Scale & Forecasting, Academic Risk alerts, Progress Insights, Share & Streaks"
        ]
      },
      {
        "heading": "Who actually needs Pro",
        "paragraphs": [
          "You probably need Pro if you need to type more than one course in by hand, because the second hand-added course is where free stops. That is common when your school does not run Canvas, when a seminar or lab is never published there, and for anyone tracking a recitation as its own course. If your classes do come from Canvas, it is a wall you may never meet.",
      ...
      },
      {
        ...
        "paragraphs": [
          "If your classes are on Canvas, connect it — every one of them arrives free and stays current — then spend your free AI action on the syllabus you least want to retype, and check the app when you want to know what is due. You will never touch another limit for that whole semester. That is not a stripped-down demo of the product — it is the whole scanner, the full extraction, the review screen with per-item editing and low-confidence badges, deadline and task tracking with no cap, grade tracking with weighted averages, your semester GPA, and same-day reminders, on every device you sign in on.",
          "What free does not do is carry the AI through a whole term. The action is one, nothing refills it, and a professor reissuing a syllabus in week seven is a Pro job rather than a free one. The honest edge of that argument is that free is a complete semester of tracking with a single run of the extraction inside it, and it is one semester. We would rather you upgrade in week two because you hit a wall you can name than in week one because a paywall implied you had to.",
          "There is a version of this app where you never see the scanner touch your own documents before you pay. That is not this one. Every free account gets one real AI action, on purpose, on your own syllabus rather than a demo file, with the review screen and the editing and the confidence flags intact. If the free tier is enough for your semester, use the free tier for your semester."
        ]
      },
      {
        "heading": "How buying Pro works",
        "paragraphs": [
          "Pro is sold two ways. You can buy it on the web at app.semoraai.com, where Stripe takes the card, or inside the iOS app through the App Store, on iPhone or iPad. There are two products on either route, a monthly subscription at $4.99 and an annual one at $29.99. Semora never sees your card details, because the transaction happens entirely inside Stripe's hosted checkout or inside Apple's payment sheet.",
          "What happens next is the part that matters for cross-device use, and it lands in the same place on both routes. When an App Store purchase completes, the app sends Apple's signed transaction to a Semora server function, which verifies it with Apple and writes an entitlement row keyed to your Semora account — your user ID, not your Apple ID. A card purchase finishes the same way, with Stripe confirming the subscription to the server and the server writing that same row. Every feature gate in the app and every server-side check reads it. That is the mechanical reason Pro is account-wide: there is only one place the answer lives, and signing in anywhere with the same email reads the same row.",
          "One consequence worth knowing before you buy, on either route: the entitlement is bound to the Semora account that was signed in at purchase. If you later tap Restore while signed into a different Semora account, the app tells you the subscription is already linked to a different Semora account rather than reporting that no subscription exists. Sign into the account that bought it and Pro comes back. If you switch to a new iPhone, Restore Purchases re-validates an App Store receipt with Apple and brings the entitlement with you."
        ]
      },
      {
        "heading": "What buying on the web looks like",
        "paragraphs": [
          "The browser has a checkout of its own. Open the paywall in the web app, pick monthly or annual, and Stripe takes the card on a hosted page; when it clears you land back in Semora with Pro already on. Two things are worth knowing before you start: there is no free trial on that route, so the first period is charged straight away, and cancelling later happens under Settings, in Manage Semora Plan, which opens Stripe's billing portal.",
          "The web can also simply read and refresh. The paywall offers a control that re-reads your entitlement from the server, which is what you use if you subscribed on your phone instead and want the browser tab to catch up immediately. Most of what Pro unlocks then works in the browser the same way it works on the phone, with two exceptions, and they are both worth naming.",
      ...
      },
      {
        ...
        "paragraphs": [
          "Monthly is $4.99. Annual is $29.99, which works out to about $2.50 a month, roughly 50 percent less than paying month to month. Twelve months of monthly billing is $59.88, so the annual plan saves $29.89 over a full year.",
          "The break-even sits just past six months. $29.99 divided by $4.99 is about 6.01, so six monthly payments cost almost exactly what a year costs. Set that against a semester: a fall term running late August through mid-December is about five months, or $24.95 in monthly billing. The annual plan is $5.04 more than that and carries you through spring as well. Given that a second semester is itself one of the things Pro unlocks, the year is the one that matches how the ceilings actually bite.",
          "The case for monthly is narrower but real. If you want Pro for one specific stretch — a finals month, a semester where you overloaded on courses — paying $4.99 and cancelling is genuinely cheaper than committing to a year. Both plans renew automatically until you cancel, so pick monthly if you expect to stop and annual if you expect to still be enrolled next term. Prices quoted here are the US prices; on the App Store Apple charges the local equivalent in other storefronts, and the app displays whatever your store reports."
        ]
      },
      {
        "heading": "Cancelling, and what happens to your data",
        "paragraphs": [
          "Where you cancel depends on how you paid. A card subscription is cancelled from inside Semora: open Settings and tap Manage Semora Plan, which opens Stripe's billing portal, and cancel there. An App Store subscription runs through Apple instead — open Settings on your iPhone, tap your name, then Subscriptions, and cancel there, or use the app's shortcut at Settings, then Manage Subscription, which opens the same Apple page directly. Apple's 24-hour rule applies to that route: cancel at least 24 hours before the period ends or the next term bills. Either way you keep Pro for the rest of the period you already paid for.",
          ...
          "One thing that catches people out, so it is stated on the delete screen in the app: deleting your Semora account does not cancel your Pro subscription. Account deletion removes your data from Semora, but the billing relationship sits with Stripe or with Apple depending on how you paid. Cancel first — in Manage Semora Plan for a card subscription, in Apple's Subscriptions settings for an App Store one — then delete the account, or the charges keep landing for a subscription attached to data that no longer exists."
        ]
      }
    ],
    "faq": [
      {
        "question": "How often does my free AI action reset?",
        "answer": "It does not. Free accounts get one AI action for the lifetime of the account — a syllabus scan, a lecture recording, or a document turned into notes, whichever you reach for first — so there is no monthly window and nothing to carry over. An extraction counts the moment it runs, so an action you start and then abandon still uses it. The scan tab shows whether it is still unspent before you commit, and warns you when you are about to spend it."
      },
      {
      ...
      },
      {
        ...
        "answer": "The one-action limit is removed entirely, which is the limit that actually shapes a semester. What stays is a fair-use ceiling of twenty scans in a rolling day, applied to every account including Pro and enforced by the extraction function, which returns a rate-limit error past that. Twenty syllabi in a day is a script rather than a course load, so it should never come up, but it is a real number and we would rather print it."
      },
      {
        "question": "Can I buy Pro on the web app?",
        "answer": "Yes. The paywall in the web app takes a card through Stripe, at the same $4.99 a month or $29.99 a year, and Pro switches on as soon as the payment clears. There is no free trial on that route. Buying inside the Semora app on iPhone or iPad through the App Store is still there if you would rather pay that way, and the web paywall also offers a control that re-reads your entitlement, so the browser catches up right after you subscribe on a phone."
      },
      {
      ...
      },
      {
        ...
        "answer": "Annual costs $29.99 against $59.88 for twelve monthly payments, so it saves $29.89, about 50 percent. The break-even is just past five months: $29.99 buys roughly five months of monthly billing. If you expect to still be enrolled next term, and a second semester is itself a Pro feature, annual is clearly cheaper. If you want Pro for one crunch stretch and then intend to stop, monthly at $4.99 and cancelling is the cheaper choice."
      },
      {
      ...
      },
      {
        ...
        "answer": "No, and this is the one thing that catches people out, so the app states it on the delete screen. Deleting your Semora account removes your data from Semora, but the billing relationship sits with whoever took the payment, not with us. Cancel first — Settings, then Manage Semora Plan for a card subscription, or Settings, Apple Account, Subscriptions for an App Store one — then delete the account, otherwise the charges keep coming for a subscription attached to data that no longer exists."
      }
    ]
  },
  "compare": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Semora's scanner is on the free tier for one AI action and takes four paths: a camera photo of up to five pages per scan, budgeted at 10 MB combined; a PDF upload; drag-and-drop on the web app; and pasted raw text on web, up to 60,000 characters at a time. From those it extracts the course name and code, the instructor, class meeting blocks with days, start and end times, kind and room, office hours, the semester start and end dates, the letter-grade scale, and every assignment, quiz, exam, project, and reading with a due date, due time, percentage weight, and a confidence score. Importing from Canvas, Blackboard, or Moodle is free on every plan. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. If token use is unavailable or not permitted, paste Canvas assignment text straight into the scanner."
        ],
        "bullets": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Semora is one universal iOS app covering iPhone and iPad, plus a web app, on one account, syncing in near real time. There is no Android app and no Mac app. Pro is sold both ways — by card on the web, processed by Stripe, and in the iOS app through the App Store — and applies account-wide whichever one you use, so a subscription started on a phone is already live in the browser and the other way round. Scheduled reminders are native-app notifications. Courses and tasks created or edited without a connection are queued locally, retried with backoff, and checked against the server version so a conflicting edit surfaces rather than silently overwriting."
        ]
      },
      {
        ...
        "paragraphs": [
          ...
          "Semora's free tier is not a trial and does not expire: one AI action for the lifetime of the account — a syllabus scan, a lecture recording, or a document turned into notes — plus unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, full deadline and task tracking, grade tracking with weighted averages, same-day reminders, and joining a Course Space a classmate invites you to. That single action does not renew, so there is nothing waiting to reset. The one thing that does end is the term itself: a free account covers one semester, so setting up the next one is where Pro is required. Classes you already connected keep syncing. The course cap applies when you create a new course in a semester, and re-scanning a course you already have does not consume another slot. Pro is $4.99 per month or $29.99 per year, which works out to about $2.50 per month annually — roughly 50 percent cheaper than paying monthly. Calendar sync with .ics export, CSV export, and the print view are Pro; if Pro lapses, device calendar sync pauses rather than deleting what it created."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          "Semora is an intake and organizing tool with a studying layer on top, in that order. The deadline and grade tracking are the core and they are free, and the scanner that feeds them gives every free account one AI action to spend. The planning and study features — Smart Plan, the Workload dashboard, Flashcards, the Focus Timer, the AI Tutor, Grade Scale & Forecasting, calendar sync, custom reminder timing with quiet hours, Academic Risk alerts, Progress Insights, and hosting a Course Space — are Pro. That split is deliberate: the facts about your semester should not be behind a paywall, and you should be able to test whether the extraction is any good on your own syllabus before deciding anything.",
  ...
  "blog": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Product mentions are labeled by tier at the point they appear, because a guide that quietly leads you toward a paywall is not a guide. Free means free: one AI action for the lifetime of the account — a syllabus scan, a lecture recording, or a document turned into notes — plus unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, full deadline and task tracking, grade tracking with weighted averages, a credit-hour-weighted semester GPA estimate, same-day reminders, and joining a Course Space a classmate invites you to. The one hard edge is semesters — a free account covers a single semester, so a second term is where Pro stops being optional. Pro is $4.99 a month or $29.99 a year, which works out to about $2.50 a month on the annual plan, bought either by card on the web or inside the iOS app, and applied to your whole account including the web app; you only ever pay for it once. Hosting your own Course Space is Pro; joining one someone shares with you is free and stays free.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes. Connecting Canvas, Blackboard or Moodle is free on every plan, and the server enforces that rather than the app merely hiding a button. The free-tier route is real, though, and the Canvas post covers it: copy your assignment list as text and paste it straight into the syllabus scanner, which accepts pasted text on the web from twenty up to sixty thousand characters."
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "\"This doesn't look like a course syllabus.\" This is a deliberate gate. It fires when the model reports the document is not a syllabus, or when the extraction comes back with no course name, no items and no meeting times — nothing usable. Semora returns before writing anything, so no phantom course or semester is created and the scan is not charged against your free AI action. Scan the syllabus, course outline, or class schedule instead of a reading list or a receipt.",
          ...
          "\"The AI is busy right now — please try again in a minute\" and \"AI service unreachable.\" These appear only after Semora has already retried with backoff and failed over to a secondary model, so waiting a minute genuinely helps. \"We're seeing unusually high demand right now\" is a different thing — an app-wide spend limit, not your account. None of these count against your free AI action. They do still count toward the rolling 24-hour cap of 20 scans described below, so a long run of failed attempts on one document can trip that separate limit even though your own count has not moved."
        ],
        "bullets": [
          ...
          "On the web app you can paste raw text instead — up to 60,000 characters. That is the route for anything your Canvas feed does not carry.",
      ...
      {
        "heading": "What the scan limit counts, and why it never resets",
        "paragraphs": [
          "Free accounts get one AI action for the lifetime of the account: spend it on a syllabus scan, a lecture recording, or turning a document into notes, whichever you reach for first. It is a lifetime allowance rather than a monthly one, so there is no reset date and nothing rolls over.",
          ...
          "The Scan tab shows whether your free action is still unspent, so you are never guessing, and it warns you before you spend it. Semora enforces the same limit in the app, on the server, and in the database, which is why the number you see and the number the server accepts always agree.",
          "One other ceiling applies to everyone, Pro included: a rolling 24-hour cap of 20 scans per account, which exists to stop runaway automated use. If you hit it you will see \"You've reached the daily scan limit of 20.\" This is also why Pro scanning is best described as having no scan quota rather than as literally unlimited — there is a fair-use daily ceiling behind it.",
          "Two further limits apply only on free, and Pro is exempt from both. The first is one course per semester that you add by hand, with Canvas-synced classes exempt and uncapped. The second is one semester per account: a free account cannot start a second semester at all, so a new term is not a way to reset the one hand-added course — unlimited courses and unlimited semesters both come with Pro. If you are at the course limit but your AI action is still unspent, Semora says exactly that and points you at re-scanning a course you already have."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Work done offline is queued on the device rather than lost — not only edits, but the courses and tasks you create while disconnected, which are given their ids up front so you can keep editing them before the server has ever seen them. Me, Settings, Offline & Sync shows exactly where things stand: Waiting, Failed and Conflicts, plus when the last successful sync happened. Queued changes retry automatically with increasing delays, and after six attempts an item is parked instead of retrying forever. Parked items are what the \"Try sync now\" button is for — it forces a retry of everything, including the items the automatic flush deliberately skips.",
      ...
      },
      {
        ...
        "paragraphs": [
          "Pro is bought once — $4.99 a month or $29.99 a year, which works out to about $2.50 a month on the annual plan — either by card on the web, where Stripe handles the checkout, or in the iOS app through Apple. What the purchase produces is a server-side entitlement attached to your account, and every surface reads that same record, which is why Pro applies account-wide, including in the browser, without a second payment.",
      ...
      },
      {
        ...
        "paragraphs": [
          "Where you cancel depends on how you paid. A card subscription is cancelled from inside Semora: open Settings and tap Manage Semora Plan, which opens Stripe's billing portal. An App Store subscription belongs to Apple, so cancel that one on your iPhone under Settings, your Apple Account, then Subscriptions — the app links straight there from Settings, Manage Subscription — and do it at least 24 hours before the period ends. Canceling stops the next renewal; Pro features keep working until the period you already paid for ends, at which point the account reverts to free limits (one lifetime AI action, one hand-added course, one semester) with all of your data intact.",
          "The trap worth naming: deleting your Semora account does not cancel your subscription. Billing keeps running until you cancel it, in Manage Semora Plan or in your Apple Account settings depending on where you bought it. The delete-account screen warns Pro users about this, but do it in this order — cancel first, then delete the account. Refunds on an App Store subscription are Apple's, requested through reportaproblem.apple.com."
        ]
      },
      {
        ...
        "paragraphs": [
          ...
          "If you only want a clean slate for a new term, deleting the account is the wrong tool for it. On Pro, just start a new semester — unlimited semesters is part of what Pro buys, and last term stays intact next to it. On free you get one semester per account, so a second one needs Pro; the clean slate there comes from reusing the semester you already have, editing or removing the courses you are done with and adding the new ones into it. And if you want your data out before you go, Pro accounts can export from Progress Insights as CSV, and Pro calendar sync can export your deadlines as an .ics file."
        ]
      }
    ],
    "faq": [
      {
        "question": "Does a failed scan use up my free AI action?",
        "answer": "No. If Semora rejects the document as not a syllabus, the response gets truncated, or the AI is unreachable, the attempt is logged as a failure and your free AI action is untouched. It does still count toward the separate rolling 24-hour cap of 20 scans, so hammering one stubborn document can trip that limit even while your action stays intact. The one case that does spend it is an extraction that succeeded, reached the review screen, and was then abandoned without saving — the work was already done and delivered. Finish the review even if you only keep a couple of items."
      },
      {
      ...
      },
      {
        ...
        "answer": "Pro is a server-side entitlement your account carries everywhere, so this is almost always a refresh problem. Reload the browser tab first. If nothing changes, open the iPhone app, go to Settings and tap Restore Purchases, that re-validates the App Store receipt and rewrites the record the web reads, then reload the tab. Do not buy again on the web while you are waiting: one subscription covers the whole account whichever way you bought it, and a second checkout would just be a second charge for the same thing."
      },
      {
      ...
      },
      {
        ...
        "answer": "No. A free account supports one semester, with unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand in it, and that is enforced both in the app and in the database, so a new term does not hand you a fresh hand-added course. Unlimited courses and unlimited semesters are part of Pro. If you want to keep going on free, reuse your existing semester: remove or edit the courses you have finished and add the new ones in."
      },
      {
        "question": "Does deleting my Semora account cancel my Pro subscription?",
        "answer": "No, and this catches people out. Billing sits outside Semora, so deleting your account leaves the subscription renewing. Cancel first — Settings, then Manage Semora Plan if you paid by card, or Settings, your Apple Account, Subscriptions on your iPhone if you bought through the App Store — then delete the account. Refunds on an App Store subscription go through Apple at reportaproblem.apple.com. Deletion itself is permanent — courses, tasks, grades, uploaded syllabi and course notes are all removed, with no recovery and no grace period."
      }
    ]
  },
  "ai-syllabus-scanner": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "The free tier includes one AI action for the lifetime of the account, and a syllabus scan is one of the three things you can spend it on, alongside a lecture recording and turning a document into notes. There is no window and no reset date: it is one action, not one a month. The scan tab shows whether it is still unspent, and before you spend it you get an explicit heads-up, so the limit is never something you discover after the fact.",
          ...
          "The count is enforced identically at every layer: the usage pill on the scan tab, a check that runs in the app before any data is written, a server-side check that runs before the extraction call itself, and a database trigger on the upload row as the last line. All four count against the same lifetime allowance and the same limit of one, so what the app tells you and what the server enforces cannot drift apart.",
          "Two other free-tier limits are separate from the scan count, and they show up in different places. The first is one hand-added course per semester, and the scan tab says so plainly: the moment you are at the cap it shows an amber note, so if your action is still unspent but you already have that course, you know to re-scan a course you already have — adding another by hand needs Pro. The second is stricter than \"one at a time\" suggests. A free account gets one semester, total. It is not a slot that frees up when the term ends and it does not roll over into spring, which is why the one course you add by hand is one course, full stop, rather than one per term. What is not capped at all is Canvas: connect it and every class you are enrolled in arrives free, however many you take. That limit is not previewed on the scan tab; it surfaces at the moment a scan would otherwise create a second term, and it is enforced both in the app and by a trigger on the semesters table, so there is no way around it.",
          "Pro is $4.99 per month or $29.99 per year, which works out to about $2.50 a month on the annual plan. You can buy it with a card on the web, where Stripe handles the checkout, or inside the iOS app, and either way it applies to your whole account, including the web app — one subscription, never two. It lifts the one-action cap and removes the course and semester limits entirely. Scanning on Pro is not literally infinite, though, and it is worth saying so plainly: every account, free or Pro, is held to a fair-use ceiling of 20 extractions per rolling 24 hours, and a request past that is refused with a note to try again in a day. Twenty scans in one day is scripted-abuse territory; a student importing a full course load never comes near it."
        ],
        "bullets": [
          "Free: 1 AI action for the lifetime of the account, with no reset",
          "One submission equals one scan, whether it is 1 page or 5",
          "Rejected non-syllabus documents and failed scans do not count",
          "Free also allows one course you add by hand, with Canvas classes unlimited and uncounted, and one semester total, not one semester per term",
          "Pro, $4.99/month or $29.99/year: no scan cap, unlimited courses and semesters",
    ...
    "faq": [
      {
        "question": "Does a rejected or failed scan use up my free AI action?",
        "answer": "No. A document classified as a non-syllabus is refused before any extraction is stored, and nothing is written (no course, no semester, no deadlines) so there is nothing to count. Failed and rejected attempts are logged separately from successful ones. Your one free action is only spent when a scan actually produced a syllabus you can review."
      },
      {
      ...
      },
      {
        ...
        "answer": "One course you add by hand, inside a single semester, plus as many Canvas-synced classes as you take. The semester limit is one per free account in total, not one per term, so a free account cannot start a second semester later — a scan that resolves to a new term stops before anything is written and offers the upgrade instead. Pro ($4.99 a month, or $29.99 a year) removes both limits along with the one-action cap. Deadline and task tracking, weighted grade averages, semester GPA, same-day reminders, and joining a Course Space a classmate invites you to are all included free."
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "One boundary is worth knowing before you start, because nothing about it renews: a free account covers one semester, total. The 4-course limit lives inside that single term and does not refill in January — a free account cannot start a second semester at all, in the app or in the database, which is where Pro's unlimited semesters actually earn their keep.",
          "Pro is $4.99 a month or $29.99 a year, which works out to about $2.50 a month and is roughly 50% cheaper annually. You buy it either by card on the web, where Stripe handles the checkout, or inside the iOS app through the App Store, and the entitlement applies to your whole account, so every surface reads the same Pro status."
        ],
        "bullets": [
          "Free: 1 AI action for the lifetime of the account — a syllabus scan, a lecture recording or a document turned into notes — unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, and one semester per account. Full deadline and task tracking, grade tracking with weighted averages, semester GPA, same-day reminders, and joining any Course Space a classmate invites you into.",
          "Pro adds the planning layer: Smart Plan, the Workload dashboard, unlimited courses and semesters, syllabus scanning with no cap (a fair-use ceiling of 20 scans in a day), custom reminder timing (1-day and 3-day) with quiet hours, device calendar sync with .ics export, hosting your own Course Space, Flashcards, the Focus Timer, the AI Tutor, Grade Scale & Forecasting, Academic Risk alerts, Progress Insights, and Share & Streaks."
        ]
      }
    ],
    "faq": [
      ...
      },
      {
        ...
        "answer": "One semester, partly. Free gives you the tracking layer: every deadline the scanner extracts, a calendar and task list, weighted grade tracking, semester GPA, same-day reminders, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand and one AI action for the life of the account. Two limits shape it. The first is that a free account gets one semester total — the single hand-added course does not reset next term, because starting a second term is itself a Pro feature. Canvas classes are uncapped and free, so the ceiling only binds work you type in yourself. The second is that the scheduling layer is Pro: Smart Plan's timed sessions and the Workload dashboard's crunch-week chart. You can plan manually from the free deadline list; Semora just will not build the schedule for you."
      }
    ]
  },
  "canvas-deadline-tracker": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Semora's shipping clients connect through the private Calendar Feed link Canvas already gives every student, so no access token is created and no administrator has to approve anything.",
      ...
      },
      {
        ...
        "paragraphs": [
          "Both are supported, and they no longer work the same way. Blackboard is thinner than Canvas and usually depends on your institution rather than on you, which is worth knowing before you buy Pro expecting the Canvas experience on a different platform. Moodle now connects from a calendar link you fetch yourself, with nothing for your school to approve.",
          ...
          "Moodle needs no token and no administrator. In your own Moodle, signed in as yourself, open Calendar → Import or export calendars → Export calendar → Get calendar URL, copy the URL, and paste it into Semora. Moodle hands every user that link by default, behind their own login, and your Moodle password is never typed into Semora — you sign in to Moodle itself, in your own browser. A school-issued web-service token still works as a secondary route, but nobody needs one. The one way this is harder than Canvas is that browser trip: Canvas's link is already sitting on its calendar page, and Moodle's has to be fetched.",
          "What a Moodle feed carries is the same as Canvas: dates, not marks. No grades, no submission status, and an assignment with no due date set never becomes a calendar event, so it does not appear.",
          "If your school runs Blackboard and will not issue a token, the paste route from the top of this page is not a consolation prize. It is the same extraction that reads a syllabus, and it does not care which LMS your school licensed."
        ]
      }
    ],
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes, with a different mechanic. The Canvas connection is free, but the free tier covers one AI action for the lifetime of the account — a syllabus scan, a lecture recording or a document turned into notes — plus unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, full deadline and task tracking, grade tracking with weighted averages, semester GPA, same-day reminders, and joining a Course Space a classmate invites you to. Copy the text of your Canvas assignments page and paste it into the scanner — it runs the same extraction as a PDF. You refresh it yourself instead of automatically. The one hard stop is that a free account covers a single semester total, so a second term needs Pro: $4.99 a month or $29.99 a year, bought by card on the web or in the iOS app and applied to your account everywhere, including web. Pro also drops the one-action cap, subject to a fair-use ceiling of 20 scans in a day."
      }
    ]
  }
};
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Learning advice is framed as a method to test, not a promise that one technique works for everyone. Product limits are stated with their real boundaries: the free account covers one AI action for the lifetime of the account, unlimited classes synced free from Canvas, Blackboard or Moodle, one course added by hand within one semester, and one semester total. Extracted deadlines remain editable and require review before they enter the calendar.',
      ],
    },
  ],
  faq: [
...
const CANVAS_TRACKER_SUMMARY: PageLongForm = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Yes. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve, so it does not depend on your institution enabling anything.',
    },
    {
