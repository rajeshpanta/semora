  ...
  "home": {
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          "Free: 1 AI action for the life of the account, up to 4 courses within one semester, one semester total",
  ...
  "ai-study-planner-for-college": {
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          "Free: 1 AI action for the lifetime of the account — a syllabus scan, a lecture recording or a document turned into notes — up to 4 courses, and one semester per account. Full deadline and task tracking, grade tracking with weighted averages, semester GPA, same-day reminders, and joining any Course Space a classmate invites you into.",
    ...
    "sections": [
      {
        ...
        "paragraphs": [
          ...
          "The free tier gives you one AI action for the lifetime of the account and up to 4 courses — inside a single semester. Be clear on that last part, because it is the limit people misread: a free account gets one semester total, not one semester at a time. The cap is enforced in the app and again by a database trigger on the semesters table, so the 4-course allowance does not reset in January. One paste is what that single action buys, so point it at the course whose dates you are least sure about. Where the paste route genuinely falls short is refresh: a paste is a snapshot, and a Canvas connection keeps re-checking. That gap, plus the second semester, is what Pro actually buys you here."
        ]
      },
      {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Learning advice is framed as a method to test, not a promise that one technique works for everyone. Product limits are stated with their real boundaries: the free account covers one AI action for the lifetime of the account, four courses within one semester, and one semester total. Extracted deadlines remain editable and require review before they enter the calendar.',
      ],
    },
  ],
  faq: [
