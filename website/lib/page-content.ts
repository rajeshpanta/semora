    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Semora's free tier is not a trial and does not expire: one AI action for the lifetime of the account — a syllabus scan, a lecture recording, or a document turned into notes — plus unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand per semester, full deadline and task tracking, grade tracking with weighted averages, same-day reminders, and joining a Course Space a classmate invites you to. That single action does not renew, so there is nothing waiting to reset. The course cap applies when you create a new course in a semester, and re-scanning a course you already have does not consume another slot. Pro is $3.99 per month or $19.99 per year, which works out to about $1.67 per month annually — roughly 58 percent cheaper than paying monthly. Calendar sync with .ics export, CSV export, and the print view are Pro; if Pro lapses, device calendar sync pauses rather than deleting what it created."
        ]
      },
      {
