...
export const PAGE_CONTENT: Partial<Record<PageKey, PageLongForm>> =
{
  ...
  "features": {
    "sections": [
      ...
      {
        "heading": "What one AI action and 4 courses actually cover",
        "paragraphs": [
      ...
      },
      {
        ...
        "bullets": [
          "Free: one AI action to spend on a scan, a lecture or notes, 4 courses, unlimited deadlines and tasks, weighted grade tracking and semester GPA, same-day reminders, Today and Calendar, and joining a Course Space.",
  ...
  "pricing": {
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "If you take four courses, spend your free AI action on the syllabus you least want to retype, enter the other three by hand, and check the app when you want to know what is due, you will never touch another limit for that whole semester. That is not a stripped-down demo of the product — it is the whole scanner, the full extraction, the review screen with per-item editing and low-confidence badges, deadline and task tracking with no cap, grade tracking with weighted averages, your semester GPA, and same-day reminders, on every device you sign in on.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Two further limits apply only on free, and Pro is exempt from both. The first is 4 courses per semester. The second is one semester per account: a free account cannot start a second semester at all, so a new term is not a way to reset the one hand-added course — unlimited courses and unlimited semesters both come with Pro. If you are at the course limit but your AI action is still unspent, Semora says exactly that and points you at re-scanning a course you already have."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          "Where you cancel depends on how you paid. A card subscription is cancelled from inside Semora: open Settings and tap Manage Semora Plan, which opens Stripe's billing portal. An App Store subscription belongs to Apple, so cancel that one on your iPhone under Settings, your Apple Account, then Subscriptions — the app links straight there from Settings, Manage Subscription — and do it at least 24 hours before the period ends. Canceling stops the next renewal; Pro features keep working until the period you already paid for ends, at which point the account reverts to free limits (one lifetime AI action, 4 courses, one semester) with all of your data intact.",
  ...
  "ai-syllabus-scanner": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Four courses, inside a single semester. The semester limit is one per free account in total, not one per term, so a free account cannot start a second semester later — a scan that resolves to a new term stops before anything is written and offers the upgrade instead. Pro ($3.99 a month, or $19.99 a year) removes both limits along with the one-action cap. Deadline and task tracking, weighted grade averages, semester GPA, same-day reminders, and joining a Course Space a classmate invites you to are all included free."
      },
      {
