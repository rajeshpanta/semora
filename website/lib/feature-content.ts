...
export const FEATURE_CONTENT: Partial<Record<FeatureSlug, FeatureLongForm>> =
{
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Deadlines become tasks on your Today tab \u2014 sorted into overdue, due today, and this week \u2014 with advance reminders on the free tier. Weights become the input to grade tracking, so a weighted average appears as soon as you start entering scores - and because the scanner pulled the grading scale off the syllabus, that percentage maps to the letter your professor actually uses rather than a generic 90/80/70. Meeting blocks become your class schedule. The stored syllabus file stays one tap away on the course screen. All of it syncs across iPhone, iPad, and the web app on one account.",
          "On the Pro side, the same extraction feeds Smart Plan's study schedule and the Workload dashboard's crunch-week view, both of which are only as good as the deadlines they have. The AI Tutor answers from the syllabus you scanned and the deadlines it produced. Flashcards can be generated from a scanned syllabus, or scoped to one specific exam pulled from your tracked deadlines. Canvas import is part of Pro and currently uses a personal access token generated in Canvas. Some institutions disable or prohibit third-party token use, so confirm your school's policy. If the connector is unavailable or not permitted, paste the Canvas assignment list into the web scanner."
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Once they are in your planner, they behave like any other task. Advance reminders apply. If you are on Pro, they feed Smart Plan and show up in the Workload dashboard like everything else. Enter a score on one and it counts toward your weighted average, privately.",
  ...
  "canvas-sync": {
    ...
    "metaDescription": "Canvas Sync imports assignments, due dates, and points on Pro through a token connection where your institution permits it.",
    "h1": "Canvas Sync: pull your Canvas assignments into Semora",
    "lede": "On Pro, Canvas import currently uses a personal access token you generate in Canvas. Connect only if your institution permits third-party token use.",
    "intro": [
