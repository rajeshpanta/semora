  ...
  "lecture-recording": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "A free account gets one AI action for the lifetime of the account, and a lecture is one way to spend it \u2014 a syllabus scan or a document turned into notes are the others, and you pick. Recording more than one class is part of Pro, at $4.99/month or $29.99/year, which also covers unlimited syllabus scans and courses."
      }
    ]
  },
  "syllabus-scanner": {
  ...
  "smart-plan": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No, it is part of Pro, which is $4.99 a month or $29.99 a year. You can buy Pro with a card on the web at app.semoraai.com, or inside the iOS app through the App Store, and the entitlement applies to your whole account, including the web app."
      }
    ]
  },
  "flashcards": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Flashcards are part of Pro, at $4.99 per month or $29.99 per year, which works out to about $2.50 a month on the annual plan. Pro is bought either with a card on the web at app.semoraai.com, where Stripe handles the checkout, or inside the iOS app through the App Store — and the entitlement applies to your whole account, including the web app, whichever way you paid. Free accounts get a genuinely usable core: full deadline and task tracking, grade tracking with weighted averages, same-day reminders, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand within one semester, one semester total, one AI action for the lifetime of the account to spend on a scan, a lecture recording, or a document turned into notes, and Course Spaces \u2014 joining a classmate's shared course is always free. Pro adds unlimited scans and courses, hosting your own Course Space, Smart Plan, the Workload dashboard, Flashcards, the Focus Timer, the AI Tutor, Grade Scale & Forecasting, calendar sync with .ics export, custom 1-day and 3-day reminders with quiet hours, Academic Risk alerts, Progress Insights, and Share & Streaks."
        ]
      },
      {
  ...
  "focus-timer": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Pro is $4.99 per month or $29.99 per year, which works out to about $2.50 a month on the annual plan. It is bought with a card on the web at app.semoraai.com, through Stripe, or inside the iOS app through the App Store, and the entitlement applies to your whole account either way, so the timer is available in the web app too. Alongside the Focus Timer, Pro covers unlimited scans and courses, Smart Plan, the Workload dashboard, Flashcards, the AI Tutor, Grade Scale & Forecasting, calendar sync with .ics export, custom reminder timing at one and three days out with quiet hours, Academic Risk alerts, Progress Insights, and Share & Streaks."
        ],
        "bullets": [
          "Free: unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand within one semester, one semester total, deadlines and tasks, weighted grade averages, same-day reminders, joining a classmate's Course Space, and one AI action for the lifetime of the account | Pro: $4.99 per month or $29.99 per year, about $2.50 a month billed annually \u2014 plus hosting your own Course Space",
          "Pro: $4.99 per month or $29.99 per year, about $2.50 a month billed annually",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No, it is part of Pro at $4.99 a month or $29.99 a year, which works out to about $2.50 a month on the annual plan. Pro is bought with a card on the web at app.semoraai.com, or inside the iOS app through the App Store, and it applies account-wide either way, so the timer is available in the web app too."
      }
    ]
  },
  "ai-tutor": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Hosting your own space — creating one and running it as owner — is part of Pro, which is $4.99 a month or $29.99 a year, about $2.50 a month on the annual plan. Pro is bought with a card on the web at app.semoraai.com, where Stripe handles the checkout, or inside the iOS app through the App Store, and it applies to your whole account either way, including the web app. The gate is enforced on the server, not just in the app, and if your Pro lapses the app routes you to the upgrade screen rather than showing a raw database error.",
  ...
  "canvas-sync": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "For Canvas, Semora reads one thing: the dated items in the Calendar Feed link you pasted. That feed carries no grades and no submission state. Moodle works the same way, from the personal calendar export link you copy out of your own Moodle: dates, and no grades or submission state either. Blackboard, which connects with a school-issued token, can also read gradebook columns. Semora never submits coursework, posts, edits, or deletes anything in your learning platform.",
      ...
      },
      {
        ...
        "paragraphs": [
          "Semora lists Canvas, Blackboard, and Moodle. Canvas connects with the private Calendar Feed link Canvas already gives you, with no token and no school approval; Moodle connects the same way, with the personal calendar export link Moodle gives every user by default, so there is nothing for an administrator to enable there either; Blackboard still uses a school-issued token, so its availability depends on school configuration.",
          ...
          "Moodle is available to anyone with a Moodle account, because the link comes from your own Moodle rather than from an administrator: open Calendar, then Import or export calendars, then Export calendar, then Get calendar URL, copy the URL, and paste it into Semora. Your Moodle password is never typed into Semora — you sign in to Moodle itself, in your own browser. The one place it is harder than Canvas is that trip out to the browser, since Canvas's link is already on the calendar page you are looking at. Like Canvas, the feed carries dates rather than marks: no grades, no submission status, and an assignment with no due date set never becomes a calendar event, so it does not appear.",
      ...
      },
      {
        ...
        "paragraphs": [
          "Connecting a learning platform is free on every plan. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. Moodle takes the same kind of link, copied out of your own Moodle under Calendar, then Import or export calendars, then Export calendar — one trip to the browser, and nothing for your school to approve. Blackboard still uses a school-issued token, so its setup varies by school. Pro is $4.99 per month or $29.99 per year, which works out to about $2.50 a month on the annual plan. It can be bought with a card on the web at app.semoraai.com, where Stripe processes the payment, or inside the iOS app through the App Store, and applies to your whole account either way, including the web app. The entitlement check happens on Semora's server before your school is ever contacted, so a free account gets a clear upgrade screen rather than a connection that mysteriously fails halfway.",
        ...
        "bullets": [
          ...
          "Semora reads at most 1,000 items from a Calendar Feed, so an unusually long history can arrive truncated; when a response looks incomplete Semora keeps what it already imported rather than deleting from it. A Moodle calendar export link is read the same way, with a 5,000-item ceiling of its own. Blackboard, which syncs course by course with a token, covers up to 50 courses at a time.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes, and both are free on every plan, exactly like Canvas. They differ in setup. Moodle connects the way Canvas does, with the personal calendar export link you copy from your own Moodle under Calendar, then Import or export calendars, then Export calendar — no token, and nothing for your school to approve, though you do have to step out to your browser once to fetch it. Blackboard uses a school-issued token, so its availability depends on your institution, and a sync covers up to 50 courses at a time with bounded pagination through each course's assignments."
      }
    ]
  }
};
