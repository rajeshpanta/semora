...
export const FEATURE_CONTENT: Partial<Record<FeatureSlug, FeatureLongForm>> =
{
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "On the Pro side, the same extraction feeds Smart Plan's study schedule and the Workload dashboard's crunch-week view, both of which are only as good as the deadlines they have. The AI Tutor answers from the syllabus you scanned and the deadlines it produced. Flashcards can be generated from a scanned syllabus, or scoped to one specific exam pulled from your tracked deadlines. Canvas sync is part of Pro and runs alongside scanning rather than replacing it, which is useful because Canvas has your assignment list but usually not your grading scale, your meeting times, or your exam schedule. On the free tier you can still get Canvas coursework in by pasting the assignment text into the scanner's paste-text path."
        ]
      },
      {
        ...
        "paragraphs": [
          ...
          "It is a weaker fit in a few honest cases. If your syllabus contains no dates at all because everything lives in the LMS, there is nothing on the page to extract; use Canvas sync for the assignment list and scan the syllabus anyway for the grading scale and class times. If the document is a photo of a whiteboard or handwriting at an angle in bad light, expect low-confidence flags and plan on editing in the review screen. If you have more than five pages of photos, use a PDF. And if you want to re-import an updated syllabus and merge only the changed deadlines into an existing course, that is not what this does - it will offer you a duplicate course instead, and the honest workaround is to edit the handful of tasks that moved.",
  ...
  "grade-tracking": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Grade tracking with weighted averages is on the free plan, and that means the whole engine: point or percentage entry, per-assignment weights, categories, drop-lowest rules, all three extra-credit policies, letter grades from your course's scale, and the semester GPA estimate. Free accounts are capped at 5 syllabus scans per calendar month and 4 courses per semester, which for a lot of students is a full course load already.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          ...
          "Easy: ease rises by 0.15, and the interval is multiplied by that ease and then by a further 1.3 bonus. A brand-new card graded Easy jumps straight to 6 days. A brand-new card graded Easy jumps straight to 6 days."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Flashcards are part of Pro, at $3.99 per month or $19.99 per year, which works out to about $1.67 a month on the annual plan. Pro is purchased in the iOS app and the entitlement applies to your whole account, including the web app — there is no separate web checkout. Free accounts get a genuinely usable core: 5 syllabus scans per calendar month, up to 4 courses per semester, full deadline and task tracking, grade tracking with weighted averages, same-day reminders, and Course Spaces \u2014 joining a classmate's shared course is always free. Pro adds unlimited scans and courses, Canvas, Blackboard, and Moodle assignment import, hosting your own Course Space, Smart Plan, the Workload dashboard, Flashcards, the Focus timer, the AI Tutor, Grade Scale and Forecasting, calendar sync with .ics export, custom 1-day and 3-day reminders with quiet hours, Academic Risk alerts, Progress Insights, and Share and Streaks. Pro adds unlimited scans and courses, Smart Plan, the Workload dashboard, Flashcards, the Focus timer, the AI Tutor, Grade Scale and Forecasting, calendar sync with .ics export, custom 1-day and 3-day reminders with quiet hours, Academic Risk alerts, Progress Insights, and Share and Streaks."
        ]
      },
      {
  ...
  "focus-timer": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          "Free: 5 scans per calendar month, 4 courses per semester, deadlines and tasks, weighted grade averages, same-day reminders, joining a classmate's Course Space | Pro: $3.99 per month or $19.99 per year, about $1.67 a month billed annually \u2014 plus Canvas, Blackboard, and Moodle import and hosting your own Course Space",
  ...
  "canvas-sync": {
    ...
    "metaDescription": "Canvas Sync imports your Canvas assignments, due dates, and points into Semora with a personal access token you generate yourself. No IT ticket needed.",
    "h1": "Canvas Sync: pull your Canvas assignments into Semora",
    "lede": "Connect Canvas with an access token you generate yourself, pick your courses, and every assignment with a due date becomes a tracked deadline in Semora.",
    "intro": [
      ...
      "Canvas Sync is Semora's way of skipping that. You generate an access token inside your own Canvas account, paste it into Semora once, pick which courses you want, and every assignment with a due date becomes a tracked deadline. After that it refreshes on its own, and a due date that moves in Canvas moves in Semora too, along with the reminder attached to it."
    ],
    "sections": [
      {
        "heading": "Why a token instead of a “Sign in with Canvas” button",
        "paragraphs": [
          "Most apps that connect to Canvas do it with OAuth, which is the flow where you tap a button, get bounced to your school's login page, and approve access. It looks cleaner. The problem is what sits behind it. An OAuth integration runs on a developer key, and developer keys are issued per Canvas instance by that institution's Canvas administrator. An app cannot just turn one on. Someone at your university has to review it and enable it for your school specifically.",
          "That means an OAuth-based Canvas app works at the schools that have already said yes and works nowhere else. If your school has not approved it, your only move is to file a ticket and wait behind whatever else is in that queue. Semesters are short. IT queues are not.",
          "A personal access token sidesteps the whole thing. It is a credential you issue to yourself, from your own Canvas account settings, using permissions you already have as a student. No administrator is involved and no per-school setup exists, so Semora works at any school running Canvas the moment you generate one.",
          "The honest trade-off is that you copy a string once instead of tapping a button. And because the token carries your own account's permissions, you should treat it like a password. It is worth knowing that you stay in control of it: the same Canvas settings page that created the token can delete it, and the moment you do, the connection stops working."
        ]
      },
      {
        "heading": "Getting your Canvas token, step by step",
        "paragraphs": [
          "Semora prints these instructions on the connect screen itself, so you do not have to keep a browser tab open next to the app. Do this part on a computer or in a mobile browser — the Canvas mobile app does not expose this screen at all.",
          "You need two things. The first is your school's Canvas web address, which is usually yourschool.instructure.com. Semora wants the full HTTPS address and trims any trailing slash for you, and if you paste something that is not a valid HTTPS URL it tells you before anything is sent anywhere, rather than handing you a generic connection failure thirty seconds later.",
          "The second is the token. When Canvas asks for an expiration date, leave it blank on purpose. If you set one, sync works fine until that date and then quietly starts failing, and the first sign you get is a deadline you never saw. An open-ended token you can revoke on demand is easier to reason about than one with a hidden fuse. Here is the sequence:"
        ],
        "bullets": [
          "Sign in to Canvas in a browser.",
          ...
          "Copy the token and paste it into Semora's token field."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          "There is no server-side cron job pulling your Canvas data on a schedule, and that is a direct consequence of where the token lives. Because your credential is stored only on your device \u2014 never in Semora's database \u2014 only your device can start the request.",
          "So sync is foreground-driven. When you open Semora, and every time you bring it back to the foreground, it checks each connection and refreshes any whose last sync is more than 30 minutes old. It needs the device to be online, it runs quietly, and it will never interrupt you with a popup — if a refresh fails, it records a status instead of shouting about it.",
          ...
          "One consequence is worth planning around. Since the token is stored per device, automatic sync only runs where that token lives. If you connect Canvas on your iPhone, the connection is visible on the web app and on your iPad, but syncing from those will ask you to reconnect there first. Pasting the same token again on the second device is all that takes."
        ]
      },
      {
        "heading": "Where your token is stored, and what Semora can do with it",
        "paragraphs": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Semora lists three platforms, and they are not equally easy. Canvas is the one you can set up yourself in about two minutes. The other two usually involve asking someone.",
          "Blackboard uses a school-issued OAuth access token, and most institutions require an administrator to approve read access before one exists for you to paste. When it does work, Semora reads your course list and each course's gradebook columns, which gives you titles, due dates, and point totals. It does not return your own scores or submission status the way Canvas does, so a Blackboard connection is strong on deadlines and lighter on grade data.",
          "Moodle needs your administrator to enable web services and issue you a token with course and assignment read access. Semora then reads your enrolled courses and their assignment activities. Quizzes built as separate Moodle activities sit outside that scope. One detail Semora handles for you: Moodle uses negative grade values to represent non-numeric scales, which are not point totals at all, so those are dropped instead of being imported as negative points and quietly corrupting your weighted average.",
          "If your school runs Canvas, start there. If it runs Blackboard or Moodle, the honest expectation is that you may need to ask your help desk whether a token is available to you at all, and the answer varies by institution."
        ]
      },
      {
        "heading": "What it costs, who it is for, and where it gets awkward",
        "paragraphs": [
          "Connecting a learning platform is a Pro feature. Pro is $3.99 per month or $19.99 per year, which works out to about $1.67 a month on the annual plan. It is purchased inside the iOS app and applies to your whole account, including the web app; there is no separate web checkout. The entitlement check happens on Semora's server before your school is ever contacted, so a free account gets a clear upgrade screen rather than a connection that mysteriously fails halfway.",
          "You still get full deadline and task tracking, grade tracking with weighted averages, same-day reminders, joining a classmate's Course Space (hosting your own is Pro), five syllabus scans per calendar month, and up to four courses per semester. There is also a manual route that costs nothing extra: copy the text off a Canvas page or a syllabus PDF, paste it into Semora's scanner, and it pulls every deadline out of it. That uses one of your five monthly scans and takes under a minute per course.",
        ...
        "bullets": [
          ...
          "Semora does not pull instructor names from the Canvas course list, so imported courses arrive with the instructor field blank. You can fill it in yourself. You can fill it in yourself.",
          ...
          "If your token expires or you revoke it, the connection shows “credentials required” and offers a Reconnect action that pre-fills your school URL. Paste a fresh token and it reconnects and syncs in one step."
        ]
      }
    ],
    "faq": [
