    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "On the Pro side, the same extraction feeds Smart Plan's study schedule and the Workload dashboard's crunch-week view, both of which are only as good as the deadlines they have. The AI Tutor answers from the syllabus you scanned and the deadlines it produced. Flashcards can be generated from a scanned syllabus, or scoped to one specific exam pulled from your tracked deadlines. Canvas import is free; Blackboard and Moodle import is part of Pro and currently uses a personal access token generated in Canvas. Some institutions disable or prohibit third-party token use, so confirm your school's policy. If the connector is unavailable or not permitted, paste the Canvas assignment list into the web scanner."
        ]
      },
      {
