    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "The free plan includes one AI action for the life of the account, up to four courses within one semester, one semester total, full deadline tracking, weighted grade tracking and same-day reminders."
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Weighted course grades and the semester GPA estimate are both on the free tier, alongside 1 AI action for the life of the account and up to 4 courses. Free covers one semester total, so think of it as a term rather than a transcript.",
    ...
    "faq": [
      {
        ...
        "answer": "Yes, in both directions. myHomework's own base version is free with ads, and its ad-free premium tier is reported at around $4.99 a year via third-party reviews, which is not confirmed on its current site. Semora's free tier gives you one AI action for the life of the account, up to 4 courses, unlimited deadlines and tasks, weighted grade tracking, your semester GPA, and same-day reminders — within one semester total, after which continuing requires Pro."
      },
      {
  ...
  "shovel-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "And if you are evaluating Semora's free tier as a permanent home, read the limits literally. Free is one AI action for the life of the account, up to four courses, and one semester total. Not one action a month, one, and not one semester at a time, one, enforced by a database trigger on the semesters table, so a free account cannot start a second term at all. If you carry five courses, or you want to still be reading this term's grades a year from now, free will not hold you. That is a real constraint, not a nudge."
        ],
        "bullets": [
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes, within limits. The free tier gives you one AI action — a syllabus scan, a lecture recording, or a document turned into notes — and up to four courses, which is enough to put a real syllabus through and judge the extraction on your own material before paying anything. Deadline tracking, weighted grade tracking, semester GPA, and same-day reminders are all included, and entering the rest of a four-course load by hand costs nothing. The hard boundary is that free covers one semester total, not one per term, so it is a single-term arrangement rather than a permanent one."
      },
      {
  ...
  "studyfetch-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Setup features sell apps. Week-nine features decide whether you keep one. Free covers knowing what is due and where you stand: full deadline and task tracking, weighted grades, semester GPA, same-day reminders, one AI action for the life of the account, up to four courses within one semester, one semester total, and joining a Course Space a classmate hosts. Pro, at $3.99 a month or $19.99 a year, is the layer that decides what to do about it.",
