...
export const NEW_PAGES: Partial<Record<NewPageKey, NewPage>> =
{
  "ai-flashcard-generator": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Flashcards are part of Pro, at $4.99 a month or $29.99 a year \u2014 about $2.50 a month annually \u2014 bought with a card on the web or inside the iOS app, and applied account-wide across iPhone, iPad and the browser.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No, it is part of Pro at $4.99 a month or $29.99 a year. The free plan covers deadline tracking, weighted grade tracking and same-day reminders, plus one AI action for the life of the account — a syllabus scan, a lecture recording, or a document turned into notes."
      },
    ]
  },
  "ai-tutor-for-college-students": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No, it is part of Pro at $4.99 a month or $29.99 a year, bought with a card on the web or inside the iOS app, and applied to your whole account either way — iPhone, iPad and the web app."
      },
    ]
  },
  "assignment-tracker-app": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "The two limits are on courses and terms, and they behave differently. The course cap counts only what you add by hand \u2014 one per term \u2014 while classes synced from Canvas are exempt and unlimited. One semester is a harder line \u2014 a free account cannot start a second term at all, so it does not roll over in January.",
          "Pro removes all three at $4.99 a month or $29.99 a year, bought with a card on the web or inside the iOS app and applied account-wide either way. But if your classes come across from Canvas in a single term and what you need is to stop missing deadlines and know your grade, the free plan does that job completely."
        ]
      },
      {
        "heading": "Where this is the wrong tool",
        "paragraphs": [
          "If every one of your courses is fully managed in your learning platform and your instructors post everything there with dates, platform import may be all you need, and that is free but subject to your institution's policy. Scanning would be solving a problem you do not have.",
  ...
  "blackboard-assignment-tracker": {
    ...
    "metaDescription": "Track Blackboard coursework with real reminders and weighted grades. Import free where your institution permits it, or scan your syllabus.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Canvas import is free for everyone, with no limit on how many classes come across. Blackboard and Moodle import is free on every plan. Moodle connects with a calendar link you copy out of your own Moodle, with no token and nothing for a school to enable. Blackboard setup varies meaningfully by institution: deployments differ in version, configuration and what integrations the school allows.",
        ...
        "bullets": [
          "Canvas, Blackboard and Moodle import is free on every plan",
          "Blackboard setup varies by institution and version",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "The free plan includes one AI action for the life of the account, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand within one semester, one semester total, full deadline tracking, weighted grade tracking and same-day reminders."
        ]
      },
      {
    ...
    "faq": [
      {
        ...
        "answer": "Yes. Canvas, Blackboard and Moodle import are all free \u2014 no Pro, no limit on classes. What Blackboard needs instead is a school-issued token your administrator approves, which is a question for your IT department rather than for us. The free plan covers the same job from the syllabus side, including pasting a Blackboard assignment list into the scanner, within the one AI action a free account gets."
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "If what you need first is simply knowing what is due, that part costs nothing. The free tier covers 1 AI action for the life of the account, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand within one semester (one semester total, because a free account cannot start a second term) full deadline and task tracking, weighted grade tracking with your semester GPA, and same-day reminders. Smart Plan, the Workload dashboard, Flashcards, the AI Tutor and the Focus Timer sit on the Pro side, at $4.99 a month or $29.99 a year, which is about $2.50 a month. Pro is bought with a card on the web or inside the iOS app, and applies to your whole account either way, the web app included."
        ],
        "bullets": [
          ...
          "Focus Timer and Smart Plan are Pro — $4.99 monthly or $29.99 yearly, bought on the web or in the iOS app, applied account-wide."
        ]
      }
    ],
    "faq": [
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Pro is $4.99 a month or $29.99 a year, which works out to about $2.50 a month. It removes the course, semester, and AI action limits, subject to a fair-use daily ceiling, and adds hosting your own Course Space, Smart Plan, the Workload dashboard, Flashcards, a Focus Timer, an AI Tutor, Grade Scale & Forecasting, device calendar sync with .ics export, 1-day and 3-day reminder timing with quiet hours, Academic Risk alerts, Progress Insights, and Share & Streaks. It is bought either with a card on the web or inside the iOS app, and the subscription applies account-wide either way, so you pay once whichever route you take.",
      ...
      },
      {
        ...
        "bullets": [
          ...
          "Price is the deciding factor. myHomework's base version is free with ads, and an ad-free premium tier is reported at around $4.99/year via third-party reviews, which is not confirmed on its current site. If that figure holds, Semora Pro at $29.99/year is the more expensive option, and there is no point pretending otherwise. Semora's free tier is the answer to that comparison, not its price.",
          "Your school runs D2L or Schoology. Semora's LMS import covers Canvas, Blackboard, and Moodle free on every plan, with Blackboard subject to school policy and platform configuration. myHomework's import reportedly covers D2L and Schoology as well. Pasting or scanning still works, but a direct connection does not.",
    ...
    "faq": [
      {
        ...
        "answer": "Yes, in both directions. myHomework's own base version is free with ads, and its ad-free premium tier is reported at around $4.99 a year via third-party reviews, which is not confirmed on its current site. Semora's free tier gives you one AI action for the life of the account, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, unlimited deadlines and tasks, weighted grade tracking, your semester GPA, and same-day reminders — within one semester total, after which continuing requires Pro."
      },
      {
        "question": "Which alternative connects to D2L or Schoology?",
        "answer": "Not Semora. Its LMS import supports Canvas, Blackboard, and Moodle, free on every plan. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. myHomework's import reportedly covers D2L and Schoology alongside Canvas, Blackboard, and Google Classroom. If a direct D2L or Schoology connection is non-negotiable, that is a genuine reason to stay."
      },
      {
      ...
      },
      {
        ...
        "answer": "Probably not, and that is worth saying directly. myHomework's ad-free premium is reported at around $4.99 a year through third-party reviews, though that is not confirmed on its current site, while Semora Pro is $4.99 a month or $29.99 a year. The comparison Semora wins on cost is its free tier against a paid one, not Pro against premium. If the lowest annual price decides it, this is not your app."
      }
    ]
  },
  "shovel-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "If your school runs Brightspace, Semora's LMS import will not help you. Semora imports from Canvas, Blackboard, and Moodle free on every plan, with Blackboard subject to school policy and platform configuration. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. Google Classroom and Google Calendar sync are not shipped features today — do not plan around them. Shovel advertises read-only sync across Canvas, Brightspace, Moodle, and Google Classroom at once, auto-refreshing roughly every 24 hours, which is broader coverage than Semora offers.",
          "And if you are evaluating Semora's free tier as a permanent home, read the limits literally. Free is one AI action for the life of the account, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, and one semester total. Not one action a month, one, and not one semester at a time, one, enforced by a database trigger on the semesters table, so a free account cannot start a second term at all. If you carry five courses, or you want to still be reading this term's grades a year from now, free will not hold you. That is a real constraint, not a nudge."
        ],
        "bullets": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Academic Risk alerts watch three specific things and nothing else: a grade trending downward, work that has gone missing, and a week that is overloaded. Around that sit the study tools — flashcards with spaced repetition built from your own syllabus and notes, a focus timer with 15, 25, 45, and 50 minute sessions and 5, 10, or 15 minute breaks, and an AI tutor scoped to what it knows about your courses. Pro also covers unlimited courses and semesters with no AI quota beyond a fair-use ceiling of 20 scans a day, hosting a Course Space for classmates, device calendar sync with .ics export, custom 1-day and 3-day reminder timing with quiet hours, and Progress Insights.",
          "Pro is $4.99 a month or $29.99 a year, which works out to about $2.50 a month annually. It is bought either with a card on the web, processed by Stripe, or inside the iOS app, and the entitlement applies to your whole account, web included. So signing up from a laptop works as well as signing up from a phone, and you pay once either way. For comparison, Shovel's official pages conflicted when checked August 30, 2026: its Pricing page showed a 7-day free trial followed by $9.79/month (with $19.99 also displayed) or $39/year, while its navigation-linked Buy page showed $33/month paid monthly or $16/month paid annually. Confirm the checkout amount.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Look at Semora if your failure mode was capture or tracking rather than scheduling: dates buried in a PDF that never reached any calendar, or a semester where you never had a trustworthy running average. Look at it especially if you want the gradebook without a subscription, if you use Canvas, or if you want to split a course with classmates through a shared Course Space, where joining one is free and hosting one is Pro. When the Canvas connection is unavailable or not permitted, the syllabus-scan and pasted-assignment-list routes remain available.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Not the same set. Semora supports Canvas, Blackboard, and Moodle import, free on every plan. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. Shovel offers read-only sync across Canvas, Brightspace, Moodle, and Google Classroom simultaneously, auto-refreshing roughly every 24 hours. If your school runs Brightspace, that is a genuine point against Semora. Google Classroom sync is not a shipped Semora feature."
      },
      {
        "question": "Can I move a semester over without paying?",
        "answer": "Yes, within limits. The free tier gives you one AI action — a syllabus scan, a lecture recording, or a document turned into notes — and unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, which is enough to put a real syllabus through and judge the extraction on your own material before paying anything. Deadline tracking, weighted grade tracking, semester GPA, and same-day reminders are all included, and connecting Canvas brings the rest of your load across free, however many classes it is. The hard boundary is that free covers one semester total, not one per term, so it is a single-term arrangement rather than a permanent one."
      },
      {
      ...
      },
      {
        ...
        "answer": "Semora Pro is $4.99 a month or $29.99 a year, about $2.50 a month annually, bought with a card on the web or inside the iOS app and applied account-wide either way. Shovel's official pages conflicted when checked August 30, 2026: its Pricing page showed a 7-day free trial followed by $9.79/month (with $19.99 also displayed) or $39/year, while its navigation-linked Buy page showed $33/month paid monthly or $16/month paid annually. Confirm the checkout amount."
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          ...
          "You need the LMS connection without paying. Importing from Canvas, Blackboard or Moodle is free on every plan, though Blackboard connection availability varies by institution. On free, or when direct Canvas import is unavailable, paste the assignments page into the scanner on the web app.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Two more mechanics decide whether the app survives contact with a real semester. Re-scanning a revised syllabus merges the new deadlines into the course you already have, without overwriting meeting times you edited and without replacing a grading scale you customized — your corrections outrank a fresh guess. Connecting a learning platform is free on every plan. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. Moodle takes one extra trip: open your own Moodle calendar, copy the export link it gives you, and paste that in. Blackboard still uses a school-issued token, so its setup varies by school. If token use is unavailable or not permitted, use the paste route above on the web app. StudyFetch's Canvas support, by contrast, is documented as an institution-deployed LTI 1.3 integration with roster sync, which is a genuinely deeper hookup when your school has it and unavailable to you when it does not."
        ]
      },
      {
        "heading": "The parts that only start mattering in week nine",
        "paragraphs": [
          "Setup features sell apps. Week-nine features decide whether you keep one. Free covers knowing what is due and where you stand: full deadline and task tracking, weighted grades, semester GPA, same-day reminders, one AI action for the life of the account, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand within one semester, one semester total, and joining a Course Space a classmate hosts. Pro, at $4.99 a month or $29.99 a year, is the layer that decides what to do about it.",
          ...
          "The rest is connective tissue, and most of it sits on the Pro side of the line. Canvas, Blackboard, and Moodle import does not: it is free on every plan, though Blackboard remains subject to school policy and platform configuration. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. Calendar sync writes deadlines into your device's calendar on iPhone and iPad, and the .ics export downloads from the web app as well, so the dates can leave either way. Custom reminder timing adds one-day and three-day advance notice with quiet hours, so a 3 a.m. push does not train you to swipe notifications away. Grade Scale & Forecasting answers what you need on the final. Flashcards generate from your syllabus and any notes you attach and come back on a spaced-repetition schedule, and the AI Tutor answers from what it knows about that course rather than the open internet. Course Spaces lets one person host a shared course and invite classmates, with joining free for everyone invited, which means a study group needs exactly one Pro subscription between them. A focus timer runs 15, 25, 45, or 50 minute blocks with 5, 10, or 15 minute breaks."
        ]
      },
      {
  ...
  "dormway-alternative": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes, and there are four manual ways in: photograph up to five pages per scan, upload a PDF, drag it onto the web app, or paste raw text. Canvas, Blackboard, and Moodle import is free on every plan. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve."
      },
      {
        "question": "How does Semora's Canvas connection differ from DormWay's?",
        "answer": "Semora supports Canvas, Blackboard, and Moodle import, free on every plan. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. DormWay states read-only sync with those platforms, merged with parsed syllabi into one semester timeline and week view. Check both products against your school because connection availability can differ by institution."
      },
      {
  ...
  "mindgrasp-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Semora's free tier is three numbers you can check against your own course load: 1 AI action per account, unlimited classes synced free from Canvas, Blackboard or Moodle plus one course you add by hand, and 1 semester per account. With that you get full deadline and task tracking, grade tracking with weighted averages, a semester GPA, same-day reminders, and joining a Course Space. Nothing expires on a date, and nothing refills either: the AI action is granted once for the life of the account rather than once a month, so spend it on the syllabus you least want to retype. Everything you add or correct by hand afterwards is unlimited. A second scan, or a second course you add by hand, is where Pro starts.",
          "Pro is $4.99 a month or $29.99 a year, about $2.50 a month on the annual plan. It lifts the course and semester ceilings, replaces the single free AI action with unlimited scans, a fair-use daily ceiling of 20 scans remains, and adds Smart Plan, the Workload dashboard, Flashcards, the Focus Timer, the AI Tutor, Grade Scale & Forecasting, calendar sync with .ics export, custom reminder timing, Academic Risk alerts, Progress Insights, hosting Course Spaces, and Share & Streaks. The purchase happens once — with a card on the web, processed by Stripe, or inside the iOS app — and applies to your whole account, the iPhone, iPad and web app all reading and refreshing the same entitlement rather than charging you a second time.",
          "Canvas import is free on every plan. Connecting Canvas takes one step: copy the private Calendar Feed link Canvas already gives you and paste it in. There is no access token to generate and nothing for your school to approve. That fallback lives on the web app because pasting text is a web-only entry point: open your Canvas assignments page in a browser, select the list, and paste it into the scanner. You get the same extraction and the same review screen, having simply done the fetching yourself. On an iPhone or iPad there is no paste path, so save or print the Canvas page to a PDF and upload the file.",
    ...
    "sections": [
        ...
        },
        {
            ...
            "paragraphs": [
                ...
                "Pro is $4.99 a month or $29.99 a year, with the full feature breakdown on the Pricing page. A subscription applies to your account across supported devices. AI use is subject to fair-use limits."
            ]
        },
        {
  ...
  download: {
    ...
    metaDescription:
      'Get Semora on iPhone, iPad and Apple Watch, or open it in any browser. One account keeps every deadline, grade and course in sync. Android and Mac are coming.',
