  ...
  "ai-flashcard-generator": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No, it is part of Pro at $3.99 a month or $19.99 a year. The free plan covers syllabus scanning, deadline tracking, weighted grade tracking and advance reminders."
      },
    ]
  },
  "ai-tutor-for-college-students": {
  ...
  "assignment-tracker-app": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Advance reminders are scheduled automatically the moment you approve the extracted dates, on the free plan. There is no per-item reminder to configure, which matters because the reminders people configure by hand are the ones they stop configuring by week four.",
      ...
      },
      {
        ...
        "paragraphs": [
          "Full deadline and task tracking, with no cap on how many assignments a course holds. Grade tracking with weighted averages, complete. Advance reminders. Joining a Course Space a classmate shares with you. Five syllabus scans per calendar month.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "The free plan includes five scans per calendar month, up to four courses within one semester, one semester total, full deadline tracking, weighted grade tracking and advance reminders."
        ]
      },
      {
        "heading": "Reminders you actually control",
        "paragraphs": [
          "Advance reminders schedule themselves as soon as you approve the extracted dates, at no cost. Pro adds one-day and three-day advance notice.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "If what you need first is simply knowing what is due, that part costs nothing. The free tier covers 5 syllabus scans a calendar month, up to 4 courses in a single semester (one semester total, because a free account cannot start a second term) full deadline and task tracking, weighted grade tracking with your semester GPA, and advance reminders. Smart Plan, the Workload dashboard, flashcards, the AI tutor and the Focus timer sit on the Pro side, at $3.99 a month or $19.99 a year, which is about $1.67 a month. Pro is purchased in the iOS app and applies to your whole account, the web app included."
        ],
        "bullets": [
  ...
  "myhomework-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "The free plan is 5 syllabus scans per calendar month, resetting on the 1st, and up to 4 courses within one semester, with one semester total. Inside that, it is not a stripped-down demo: deadlines, tasks, and subtasks are unlimited, grade tracking with weighted averages is included, your semester GPA sits on the courses screen, advance reminders work, and joining a Course Space a classmate invites you to is free permanently. Five pages photographed in a single pass counts as one scan, and re-scanning a course you already have merges into it, so a revised syllabus in week two costs a scan but not a course slot.",
    ...
    "faq": [
      {
        ...
        "answer": "Yes, in both directions. myHomework's own base version is free with ads, and its ad-free premium tier is reported at around $4.99 a year via third-party reviews, which is not confirmed on its current site. Semora's free tier gives you 5 syllabus scans per calendar month, up to 4 courses, unlimited deadlines and tasks, weighted grade tracking, your semester GPA, and advance reminders — within one semester total, after which continuing requires Pro."
      },
      {
  ...
  "shovel-alternative": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes, within limits. The free tier gives you five syllabus scans per calendar month and up to four courses, which covers a standard four-course load with one scan spare for a revised syllabus. Deadline tracking, weighted grade tracking, semester GPA, and advance reminders are all included. The hard boundary is that free covers one semester total, not one per term, so it is a single-term arrangement rather than a permanent one."
      },
      {
      ...
      },
      {
        ...
        "answer": "Semora Pro is $3.99 a month or $19.99 a year, about $1.67 a month annually, purchased in the iOS app and applied account-wide including web. There is no web checkout. Shovel's official pages conflicted when checked August 9, 2026: its Pricing page showed a 7-day free trial followed by $9.79/month (with $19.99 also displayed) or $39/year, while its navigation-linked Buy page showed $33/month paid monthly or $16/month paid annually. Confirm the checkout amount."
      },
      {
  ...
  "studyfetch-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Setup features sell apps. Week-nine features decide whether you keep one. Free covers knowing what is due and where you stand: full deadline and task tracking, weighted grades, semester GPA, advance reminders, five scans per calendar month, up to four courses within one semester, one semester total, and joining a Course Space a classmate hosts. Pro, at $3.99 a month or $19.99 a year, is the layer that decides what to do about it.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "The free tier gives you capture and list without the analysis layer: full deadline and task tracking, your class schedule, grade tracking with weighted averages, semester GPA, and advance reminders. Smart Plan, the workload dashboard, flashcards, the focus timer (15, 25, 45, or 50-minute blocks with 5, 10, or 15-minute breaks), the AI tutor, device calendar sync, and per-task custom reminder timing with quiet hours sit behind Pro."
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Then a date moves, which is where a planner earns its place or becomes another thing to maintain. You change it once, on whichever device is in your hand. Reminders for that task are cancelled and rebuilt — the standard 3-day, 1-day and morning-of set on every tier, plus per-task custom timing and quiet hours on Pro. The device calendar event refreshes if calendar sync is on, which is Pro and writes to the calendar on your iPhone or iPad rather than inside a browser tab, though the .ics export downloads on web perfectly well. The week scoring recomputes and can clear a crunch week or create one. Academic Risk alerts, also Pro, watch three specific signals: overdue work; a course whose last three graded items average seven or more points below the three before them or sits under 70 percent; and an overloaded week, which means five or more deadlines inside the next seven days, or three or more when their combined weighted load is high enough. Each arrives with a first step rather than a red badge."
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "That is the entire business model. There are no ads anywhere in the app or on this site, and no advertising SDK in the build. Your data is not sold, brokered or shared with data partners — the third parties involved are the ones required to run the thing, and they are listed in the privacy policy: the database and auth provider, the AI processing API, the speech-to-text API used only if you record a lecture, Apple for purchases, and the push delivery service.",
          "It is also worth being straightforward about why the free tier is metered the way it is. Every scan is a paid model call, and so is every tutor answer and every generated flashcard deck. Those costs are per use, not per user, which is why the free limit lands on scanning rather than on the parts that cost nothing to run. Deadlines, tasks and subtasks are unlimited on free and always have been. Grade tracking, weighted averages and semester GPA are free. Advance reminders are free. Joining a Course Space a classmate hosts is free, permanently.",
