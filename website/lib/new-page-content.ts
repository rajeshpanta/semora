    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Weighted course grades and the semester GPA estimate are both on the free tier, alongside 5 syllabus scans per calendar month and up to 4 courses. Free covers one semester total, so think of it as a term rather than a transcript.",
          ...
          "One limitation, stated plainly: Semora calculates course grades and a semester GPA. It does not calculate a cumulative GPA, which needs final letters and credit hours from every term you have completed — data that lives with your registrar rather than in any syllabus. For that number, use the prior-GPA formula in the third section above. Semora runs on iPhone, iPad and the web on one account with near real-time sync, and Pro is purchased in the iOS app and applies account-wide, web included."
        ]
      }
    ],
    "faq": [
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "If what you need first is simply knowing what is due, that part costs nothing. The free tier covers 5 syllabus scans a calendar month, up to 4 courses in a single semester (one semester total, because a free account cannot start a second term) full deadline and task tracking, weighted grade tracking with your semester GPA, and same-day reminders. Smart Plan, the Workload dashboard, flashcards, the AI tutor and the Focus timer sit on the Pro side, at $3.99 a month or $19.99 a year, which is about $1.67 a month. Pro is purchased in the iOS app and applies to your whole account, the web app included."
        ],
        "bullets": [
          ...
          "Focus timer and Smart Plan are Pro — $3.99 monthly or $19.99 yearly, bought in the iOS app, applied account-wide."
        ]
      }
    ],
    "faq": [
      ...
      },
      {
        ...
        "answer": "No. The Focus timer is a Pro feature, at $3.99 a month or $19.99 a year, which works out around $1.67 a month. Pro is purchased in the iOS app and applies to your whole account, the web app included. The timer on this page is free and offers the same lengths, so if a plain countdown is what you need, use this one. Semora's version adds attachment to a specific deadline or Smart Plan block, and background notifications on iPhone and iPad."
      },
      {
  ...
  "myhomework-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "The free plan is 5 syllabus scans per calendar month, resetting on the 1st, and up to 4 courses. Inside that, it is not a stripped-down demo: deadlines, tasks, and subtasks are unlimited, grade tracking with weighted averages is included, your semester GPA sits on the courses screen, same-day reminders work, and joining a Course Space a classmate invites you to is free permanently. Five pages photographed in a single pass counts as one scan, and re-scanning a course you already have merges into it, so a revised syllabus in week two costs a scan but not a course slot.",
          ...
          "Pro is $3.99 a month or $19.99 a year, which works out to about $1.67 a month. It removes the course, semester, and monthly scan limits, subject to a fair-use daily ceiling, and adds Canvas, Blackboard, and Moodle import, hosting your own Course Space, Smart Plan, the Workload dashboard, Flashcards, a Focus timer, an AI Tutor, Grade Scale and Forecasting, device calendar sync with .ics export, 1-day and 3-day reminder timing with quiet hours, Academic Risk alerts, Progress Insights, and Share and Streaks. It is purchased inside the iOS app and applies account-wide including on the web, where there is no separate checkout.",
          "One useful thing to know if you stay free and your school uses Canvas: open your assignments page, select the list, and paste it into the scanner on the web. You get the same extraction and the same review screen without the Pro LMS connection."
        ]
      },
      {
        ...
        "bullets": [
          ...
          "Your school runs D2L or Schoology. Semora's LMS import covers Canvas, Blackboard, and Moodle, and it is a Pro feature. myHomework's import reportedly covers D2L and Schoology as well. Pasting or scanning still works, but a direct connection does not.",
    ...
    "faq": [
      {
        ...
        "answer": "Yes, in both directions. myHomework's own base version is free with ads, and its ad-free premium tier is reported at around $4.99 a year via third-party reviews, which is not confirmed on its current site. Semora's free tier gives you 5 syllabus scans per calendar month, up to 4 courses, unlimited deadlines and tasks, weighted grade tracking, your semester GPA, and same-day reminders — within one semester total, after which continuing requires Pro."
      },
      {
        "question": "Which alternative connects to D2L or Schoology?",
        "answer": "Not Semora. Its LMS import covers Canvas, Blackboard, and Moodle, connected with a personal access token you generate yourself so there is no OAuth review to wait through, and connecting a platform is a Pro feature. myHomework's import reportedly covers D2L and Schoology alongside Canvas, Blackboard, and Google Classroom. If a direct D2L or Schoology connection is non-negotiable, that is a genuine reason to stay. Otherwise, scanning the syllabus or pasting the assignments page gets the same dates in on the free plan."
      },
      {
        "question": "Can I import my existing planner data into Semora?",
        "answer": "No. Semora's import paths are the four scan routes (camera photo, PDF, web drag-and-drop, and pasted text) plus Canvas, Blackboard, and Moodle on Pro. There is no importer that reads another planner's file. In practice, scanning your syllabi again is usually faster than any migration would have been, because the scan pulls the weights and grading scale a planner export would not have carried anyway."
      },
      {
  ...
  "shovel-alternative": {
    ...
    "sections": [
      {
        ...
        "paragraphs": [
          ...
          "The third is the bill. Shovel's pricing is not consistently verifiable from the outside. Its pricing page currently lists $9.79/month, discounted from $19.99, and $39/year, while other sources cite different figures — around $20/month, roughly $200/year, or a separate lifetime tier. Treat any single number, including the ones in this paragraph, as unverified and check shovelapp.io/pricing directly. What is predictable is the switching moment: an introductory rate ends, the renewal lands at the undiscounted price, and you go looking for what else exists.",
        ...
        "bullets": [
          ...
          "The bill: an introductory rate ends, the renewal lands at the undiscounted price, and that prompts a rethink.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "If your school runs Brightspace, Semora's LMS import will not help you. Semora imports from Canvas, Blackboard, and Moodle, and that import is part of Pro rather than the free tier. Google Classroom and Google Calendar sync are not shipped features today — do not plan around them. Shovel advertises read-only sync across Canvas, Brightspace, Moodle, and Google Classroom at once, auto-refreshing roughly every 24 hours, which is broader coverage than Semora offers.",
          "And if you are evaluating Semora's free tier as a permanent home, read the limits literally. Free is five syllabus scans per calendar month, up to four courses, and one semester total. Not one semester at a time, one, enforced by a database trigger on the semesters table, so a free account cannot start a second term at all. If you carry five courses, or you want to still be reading this term's grades a year from now, free will not hold you. That is a real constraint, not a nudge."
        ],
        "bullets": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Academic Risk alerts watch three specific things and nothing else: a grade trending downward, work that has gone missing, and a week that is overloaded. Around that sit the study tools — flashcards with spaced repetition built from your own syllabus and notes, a focus timer with 15, 25, 45, and 50 minute sessions and 5, 10, or 15 minute breaks, and an AI tutor scoped to what it knows about your courses. Pro also covers unlimited courses and semesters with no monthly scan cap, Canvas, Blackboard, and Moodle import, hosting a Course Space for classmates, device calendar sync with .ics export, custom 1-day and 3-day reminder timing with quiet hours, and Progress Insights.",
          "Pro is $3.99 a month or $19.99 a year, which works out to about $1.67 a month annually. It is purchased inside the iOS app and the entitlement applies to your whole account, web included. There is no web checkout, which is worth knowing if you were planning to sign up from a laptop. For comparison, Shovel's pricing page currently lists $9.79/month, discounted from $19.99, and $39/year, but other sources cite different figures, so verify it at the source before treating any of it as settled.",
          "The free tier does not expire. The scan counter refills on the 1st of each calendar month, UTC, and the free features stay on for as long as you keep using the app. What it is instead is a single-term product: four courses, one semester, and no second term without paying. Read that as the honest boundary rather than a growth tactic, because it is enforced in the database and will not bend."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Look at Semora if your failure mode was capture or tracking rather than scheduling: dates buried in a PDF that never reached any calendar, or a semester where you never had a trustworthy running average. Look at it especially if you want the gradebook without a subscription, if you use Canvas and would rather generate your own personal access token than wait on an OAuth app review, that import sits in Pro, or if you want to split a course with classmates through a shared Course Space, where joining one is free and hosting one is Pro.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Not the same set, and not on the same tier. Semora imports from Canvas, Blackboard, and Moodle on Pro, using a personal access token you generate yourself inside the platform, so no OAuth app review or school approval is involved. On the free tier you can paste a Canvas assignments page straight into the scanner instead and get the same extraction. Shovel offers read-only sync across Canvas, Brightspace, Moodle, and Google Classroom simultaneously, auto-refreshing roughly every 24 hours. If your school runs Brightspace, that is a genuine point against Semora. Google Classroom sync is not a shipped Semora feature."
      },
      {
        "question": "Can I move a semester over without paying?",
        "answer": "Yes, within limits. The free tier gives you five syllabus scans per calendar month and up to four courses, which covers a standard four-course load with one scan spare for a revised syllabus. Deadline tracking, weighted grade tracking, semester GPA, and same-day reminders are all included. The hard boundary is that free covers one semester total, not one per term, so it is a single-term arrangement rather than a permanent one."
      },
      {
      ...
      },
      {
        ...
        "answer": "Semora Pro is $3.99 a month or $19.99 a year, about $1.67 a month annually, purchased in the iOS app and applied account-wide including web. There is no web checkout. Shovel's pricing is not consistently verifiable: its pricing page currently lists $9.79/month, discounted from $19.99, and $39/year, while other sources cite around $20/month, roughly $200/year, or a lifetime tier. Check shovelapp.io/pricing directly."
      },
      {
      ...
      },
      {
        ...
        "answer": "Re-scan it into the course you already have and the deadlines merge in, matched by course code or exact name. It costs one of your monthly scans but not a course slot. Two things deliberately do not change: your meeting times are never overwritten, and the grading scale is replaced only if you left it on the default. So a revision that moves your lecture room stays a manual edit on the course screen."
      }
    ]
  },
  "studyfetch-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          ...
          "Who owns the LMS connection — you or your registrar? Institution-deployed integrations are more powerful and completely out of your hands. Student-held credentials work at any school, on any timeline. Ask which tier the connection sits on, too: in Semora it is part of Pro.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "The last one deserves an honest sentence rather than a bullet. Semora launched recently and has no meaningful public rating history, so you cannot evaluate it the way you would evaluate a product with thousands of reviews. What you can do is run the free tier against your own syllabi for a couple of weeks and judge the extraction on your actual courses, which is better evidence than any star average anyway."
        ],
        "bullets": [
          "You are on Android. Semora is iPhone, iPad, and web. The web app works in an Android browser and covers scanning, deadlines, grades, and the .ics export, which downloads straight from the browser, but device calendar sync, the part that writes deadlines into your phone's own calendar app, does not run in a browser, and Pro is purchased inside the iOS app. StudyFetch, by its published information, is on web, iOS, and Android.",
          ...
          "You need the LMS connection without paying. Importing from Canvas, Blackboard, or Moodle is part of Pro. On free the substitute is pasting your assignments page into the scanner, and that paste route exists only on the web app.",
          "You have no Apple device at all. There is no web checkout, so Pro cannot be bought from a browser.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Two more mechanics decide whether the app survives contact with a real semester. Re-scanning a revised syllabus merges the new deadlines into the course you already have, without overwriting meeting times you edited and without replacing a grading scale you customized — your corrections outrank a fresh guess. And connecting a learning platform is a Pro feature, built on a personal access token you generate yourself inside Canvas — the same token approach covers Blackboard and Moodle, so there is no OAuth app-review dependency and nothing for your school to enable, and no waiting on IT. On free, the substitute is the paste route above, on the web app. StudyFetch's Canvas support, by contrast, is documented as an institution-deployed LTI 1.3 integration with roster sync, which is a genuinely deeper hookup when your school has it and unavailable to you when it does not."
        ]
      },
      {
        "heading": "The parts that only start mattering in week nine",
        "paragraphs": [
          "Setup features sell apps. Week-nine features decide whether you keep one. Free covers knowing what is due and where you stand: full deadline and task tracking, weighted grades, semester GPA, same-day reminders, five scans per calendar month, up to four courses inside one semester, and joining a Course Space a classmate hosts. Pro, at $3.99 a month or $19.99 a year, is the layer that decides what to do about it.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Then budget the scans. Four syllabi is four scans, which leaves one spare inside the same month for the professor who posts a revision in week two. The counter resets on the first of each calendar month, UTC, and five photographed pages submitted in one pass counts as one scan, not five — the constraint on that pass is the 10 MB budget, not the page count alone. Courses and scans are separate limits: re-scanning a syllabus into a course you already have spends a scan but not a course slot. Watch the four-course cap if a classmate invites you to a Course Space, because the course it imports takes one of the four.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No native Android app. Semora runs on iPhone, iPad, and the web, sharing one account with near real-time sync. The web app opens in an Android browser and covers scanning, deadlines, grades, and the .ics export, which downloads straight from the browser. What does not run in a browser is device calendar sync, the part that writes your deadlines into the phone's own calendar app, and Pro is purchased inside the iOS app, with no web checkout. StudyFetch, by its published information, is available on web, iOS, and Android."
      },
      {
        "question": "Does my school need to set anything up for Canvas sync?",
        "answer": "Not for Semora, but check the tier before you count on it. Importing from Canvas, Blackboard, or Moodle is part of Pro. You generate a personal access token yourself inside Canvas and paste it into Semora, so there is no OAuth app-review dependency and nothing for your institution to enable or approve. On the free tier you can still get Canvas coursework in by copying your assignments page and pasting it into the scanner on the web app. StudyFetch documents an LTI 1.3 integration with Canvas, Blackboard, Schoology, D2L Brightspace, and Google Classroom including roster sync, but it is deployed at the institution level rather than connected by an individual student."
      },
      {
        "question": "What does Semora cost compared with StudyFetch?",
        "answer": "Semora Pro is $3.99 a month or $19.99 a year, about $1.67 a month annually, bought in the iOS app and applied account-wide including on web. StudyFetch's tiers are reported by third-party review sites rather than confirmed on its own pricing page: roughly $7.99 a month for Base, around $11.99 for Premium, about $49.99 for a semester bundle, and around $99.99 annually. Check its current pricing page before deciding."
      },
      {
        "question": "How much can I do on Semora's free tier before committing?",
        "answer": "Enough to judge it on your own courses. Free gives you five syllabus scans per calendar month, up to four courses, full deadline and task tracking, weighted grade tracking, your semester GPA, same-day reminders, and joining a Course Space a classmate hosts. What free does not include is the LMS import — Canvas, Blackboard, and Moodle connections are Pro, though you can paste an assignments page into the scanner on the web app instead. The one hard edge is that free covers one semester total, enforced at the database level, so it is a full term of use rather than a rolling allowance."
      },
      {
  ...
  "dormway-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          ...
          "Your school runs Brightspace, D2L, Sakai, or anything outside Canvas, Blackboard, and Moodle. Semora's LMS import covers those three. The fallback is real (paste your assignment list into the scanner on web, anywhere from 20 to 60,000 characters) but a paste is not a sync.",
          ...
          "You want to pay on the web. Pro is purchased inside the iOS app and applies account-wide including the web app; there is no web checkout at all.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "The free tier gives you capture and list without the analysis layer: full deadline and task tracking, your class schedule, grade tracking with weighted averages, semester GPA, and same-day reminders. Smart Plan, the workload dashboard, flashcards, the focus timer (15, 25, 45, or 50-minute blocks with 5, 10, or 15-minute breaks), the AI tutor, device calendar sync, and custom 1-day and 3-day reminder timing with quiet hours sit behind Pro."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          "Semora's free tier is three numbers: 5 syllabus scans per calendar month, up to 4 courses, and one semester per account. The scan counter resets on the first of the month. The course cap is counted separately from it. The semester cap is the one people miss, and it is enforced in the database rather than only in the app. Pro is $3.99 a month or $19.99 a year, about $1.67 a month annually, and it removes the course and semester limits, drops the monthly scan cap to a fair-use daily ceiling, and adds LMS import, Course Space hosting, Smart Plan, the workload dashboard, flashcards, the focus timer, the AI tutor, grade forecasting, device calendar sync with .ics export, custom reminder timing, Academic Risk alerts, and Progress Insights. It is bought in the iOS app and applies account-wide, web included.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes, and there are four ways in. Photograph up to five pages per scan, upload the PDF, drag it onto the web app, or paste raw text — anywhere from 20 to 60,000 characters, which is generous enough for a full syllabus and low enough for a copied assignment list. Canvas, Blackboard, and Moodle import is a Pro feature and uses a personal access token you generate yourself, so there is no OAuth review wait."
      },
      {
        "question": "How does Semora's Canvas connection differ from DormWay's?",
        "answer": "Semora connects to Canvas, Blackboard, or Moodle with a personal access token you generate inside the platform, so the connection does not depend on an OAuth app-review process. Connecting is a Pro feature. DormWay states read-only sync with Canvas, Blackboard, and Moodle, merged together with parsed syllabi into one semester timeline and week view. Both cover the same three platforms; the difference is how the connection is made and what it costs."
      },
      {
    ...
    "sections": [
      {
        ...
        "paragraphs": [
          ...
          "Three other triggers show up constantly, and none of them is really about output quality. The first is arithmetic you cannot do: Mindgrasp does not list pricing on its own site at the time of this writing, and third-party review sites report roughly $5.99 to $10.99 a month across tiers, cheaper billed annually — a figure Mindgrasp itself has not confirmed, so it is worth checking their current pricing directly before comparing anything to it. The second is rhythm: a content-to-notes tool gets used in bursts around exams and billed every month regardless. The third is device. Mindgrasp ships an iOS app on the App Store published by Apricot AI, plus a web app and a Chrome extension; Android availability is unclear, and no dedicated Android app was found in the sources reviewed."
        ],
        "bullets": [
          ...
          "You cannot compare value without a published price, so the math stays guesswork.",
      ...
      },
      {
        ...
        "bullets": [
          ...
          "You want to pay on the web. Pro is purchased in the iOS app through StoreKit and applies account-wide, web included. There is no web checkout at all."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          "Semora's free tier is three numbers you can check against your own course load: 5 syllabus scans per calendar month, up to 4 courses, and 1 semester per account. With that you get full deadline and task tracking, grade tracking with weighted averages, a semester GPA, same-day reminders, and joining a Course Space. Nothing expires on a date. The scan counter resets at the start of each calendar month, so the professor who posts a revised syllabus in week three draws on a fresh allowance, and re-scanning a course you already have costs a scan but not a course slot. Four syllabi in week one leaves you one spare. A fifth course is where Pro starts.",
          "Pro is $3.99 a month or $19.99 a year, about $1.67 a month on the annual plan. It lifts the course and semester ceilings, removes the monthly scan cap entirely, a fair-use daily ceiling of 20 scans remains, and adds Canvas, Blackboard, and Moodle import, Smart Plan, the Workload dashboard, flashcards, the focus timer, the AI tutor, Grade Scale and Forecasting, calendar sync with .ics export, custom reminder timing, Academic Risk alerts, Progress Insights, hosting Course Spaces, and Share and Streaks. The purchase happens once in the iOS app and applies to your whole account, the web app included, which reads and refreshes that entitlement rather than running a second checkout.",
          "Canvas import deserves one caveat and one workaround. It is Pro, gated on the server, and it connects using a personal access token you generate yourself inside Canvas, so nothing depends on your school's IT department approving a third-party app. The free route around it is real, but it lives on the web app, because pasting text is a web-only entry point: open your Canvas assignments page in a browser, select the list, and paste it into the scanner on the web app. You get the same extraction and the same review screen, having simply done the fetching yourself. On an iPhone or iPad there is no paste path at all, so the equivalent there is saving or printing that Canvas page to a PDF and uploading the file.",
          "Set that against the other side carefully. Mindgrasp does not publish pricing on its own site at the time of this writing; third-party review sites report roughly $5.99 to $10.99 a month across tiers, less if billed annually, and that range is not confirmed by Mindgrasp itself. Treat it as a pointer to check rather than a number to compare against, and read their current pricing page before you decide anything on cost."
        ]
      }
    ],
    "faq": [
      ...
      },
      {
        ...
        "answer": "Semora's price is confirmed directly: free, or Pro at $3.99 a month or $19.99 a year. Mindgrasp does not list pricing on its own site as of this writing, and third-party review sites report roughly $5.99 to $10.99 a month across tiers, cheaper billed annually — a figure Mindgrasp has not confirmed. Check their current pricing page yourself before treating any comparison on cost as settled."
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "There is a second reason, and it is structural rather than editorial. Building on someone else's platform means your product works at the pleasure of that platform's review process. Semora does import from Canvas, Blackboard and Moodle as a Pro feature, and it does it with a personal access token you generate yourself inside the platform's own settings, specifically so the connection does not depend on your school's IT department approving a third-party OAuth app. Even so, an integration built against Google Classroom did not ship, because it required a scope verification that was not in place at submission. That is the dependency in one sentence. An LMS connection is a good second input. It is a bad foundation.",
          "If you are on the free tier and your deadlines live in Canvas anyway, there is a path that costs nothing: sign in to the web app on a laptop, open your Canvas assignments page, select the text, and paste it into the scanner there. Same extraction, same review screen, one of your five monthly scans. It is the web app specifically, because pasting text is not an entry point on iPhone or iPad."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Syllabus content and any notes you attach to the tutor are sent to Google's Gemini API for processing, and are not retained by Google for model training. Learning-platform access tokens are treated as more sensitive than that: on iOS the token is written to the device's secure storage, the same Keychain-backed store that holds your session, and is passed to the server per request rather than being stored in Semora's database. Your auth tokens live there too.",
        ...
        "bullets": [
          ...
          "Syllabus and note content sent to Gemini for processing, not retained for training.",
          "Learning-platform tokens and session tokens in the device's secure storage on iOS, not in the database.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "A free account gets 5 syllabus scans per calendar month, up to 4 courses, and one semester in total. The scan limit is checked in three separate places — in the app, in the parsing function on the server before any paid extraction runs, and again by a trigger on insert. The course limit and the semester limit are checked in two: in the app, and by a BEFORE INSERT trigger that refuses the row outright. Pro removes the monthly scan cap and leaves one fair-use ceiling behind it, around 20 scans in any rolling 24 hours, which exists to stop scripted abuse of a paid endpoint and which a normal term does not approach.",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "The same standard requires disclosing limits that do not help us. That free is one semester in total. That the fifth course stops you whether it arrives by scan, by hand, or by joining a classmate's Course Space. That hosting a Course Space is Pro, while joining one is free. That device calendar sync writes to your phone's calendar and does not run in a browser, where the equivalent is downloading an .ics file, which the web app does do. That Pro is purchased inside the iOS app, so there is no web checkout: if you never use an iPhone or iPad, there is currently no way to buy it.",
      ...
      },
      {
        ...
        "paragraphs": [
          "One subscription, two prices. Pro is $3.99 a month or $19.99 a year, which works out to about $1.67 a month. It is purchased inside the iOS app through Apple's StoreKit, and the entitlement attaches to your account rather than your device, so signing in to the web app with the same account turns Pro on there with no second charge and nothing to activate.",
          "That is the entire business model. There are no ads anywhere in the app or on this site, and no advertising SDK in the build. Your data is not sold, brokered or shared with data partners — the third parties involved are the ones required to run the thing, and they are listed in the privacy policy: the database and auth provider, the AI processing API, Apple for purchases, and the push delivery service.",
          "It is also worth being straightforward about why the free tier is metered the way it is. Every scan is a paid model call, and so is every tutor answer and every generated flashcard deck. Those costs are per use, not per user, which is why the free limit lands on scanning rather than on the parts that cost nothing to run. Deadlines, tasks and subtasks are unlimited on free and always have been. Grade tracking, weighted averages and semester GPA are free. Same-day reminders are free. Joining a Course Space a classmate hosts is free, permanently.",
          "The free tier has no expiry date, either. The scan counter refills on the 1st of every calendar month, measured in UTC, and free features do not degrade if you never subscribe. If you subscribe and then stop, nothing is deleted. Your courses, deadlines, grades and notes stay readable and editable, and the free limits reapply only when you add something new. What does change is access to the Pro surfaces: flashcard decks, the Workload dashboard, Smart Plan, Progress Insights, the AI tutor and device calendar sync go back behind the paywall until you resubscribe. The data behind them is still sitting there (a lapsed subscription pauses an active calendar sync rather than unwriting it, and a deck you built is locked, not erased) but you cannot open those screens again until Pro is back on the account."
        ]
      },
      {
    ...
    "faq": [
      {
        ...
        "answer": "Semora is built independently, without outside funding or a company behind it, and the address on the support page reaches the person who writes the code. There is no team size, headcount or investor list to publish here, because publishing one would mean inventing it. What is verifiable is the product: an iOS app on the App Store, a web app, a privacy policy, and this site's claims checked against the shipping source. Email rajesh.panta08@gmail.com and a person reads it."
      },
      {
        "question": "Is my syllabus used to train an AI model?",
        "answer": "No. Syllabus content, and any lecture notes you attach to the AI tutor, are sent to Google's Gemini API for processing and are not retained by Google for model training. The files themselves are stored in a private bucket scoped to your own account folder, not in a public location with a shareable URL, and they are deleted along with everything else if you delete your account. The extraction result is structured data written to your account and nowhere else."
      },
      {
