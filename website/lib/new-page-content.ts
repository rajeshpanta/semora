  ...
  "myhomework-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "The free plan is 5 syllabus scans per calendar month, resetting on the 1st, and up to 4 courses within one semester, with one semester total. Inside that, it is not a stripped-down demo: deadlines, tasks, and subtasks are unlimited, grade tracking with weighted averages is included, your semester GPA sits on the courses screen, same-day reminders work, and joining a Course Space a classmate invites you to is free permanently. Five pages photographed in a single pass counts as one scan, and re-scanning a course you already have merges into it, so a revised syllabus in week two costs a scan but not a course slot.",
  ...
  "studyfetch-alternative": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          "Setup features sell apps. Week-nine features decide whether you keep one. Free covers knowing what is due and where you stand: full deadline and task tracking, weighted grades, semester GPA, same-day reminders, five scans per calendar month, up to four courses within one semester, one semester total, and joining a Course Space a classmate hosts. Pro, at $3.99 a month or $19.99 a year, is the layer that decides what to do about it.",
