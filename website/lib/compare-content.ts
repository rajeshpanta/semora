  ...
  "mindgrasp": {
    "extraSections": [
      ...
      },
      {
        ...
        "body": [
          ...
          "One more limit worth stating plainly: Canvas, Blackboard, and Moodle import is a Pro feature, gated on the server, in the settings screen, and on the deep link. The free path around it is real. Open your Canvas assignments page, select the list, and paste it into the scanner as text. You get the same extraction and the same review screen — you have simply done the fetching yourself."
        ]
      },
      {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Yes, by pasting. Direct Canvas, Blackboard, and Moodle import is a Pro feature, gated on the server as well as in the app. But the scanner accepts raw pasted text on the web app, anywhere from 20 to 60,000 characters, so you can select your Canvas assignments list, paste it in, and get the same extraction and the same editable review screen. You are doing the fetching yourself, and it draws on your five monthly scans."
      },
      {
  ...
  "taskade": {
    "extraSections": [
      ...
      },
      {
        ...
        "body": [
          ...
          "Two things students often assume are free here are not, and it is worth being blunt about them. Canvas, Blackboard, and Moodle import is a Pro feature — the sync function itself returns a Pro-required error, and the provider list and connect deep link are both gated. Hosting your own Course Space is Pro as well, though joining one someone else hosts is free and stays free. The free workaround for LMS import is not a consolation prize: open your assignment list in Canvas, copy the text, and paste it into the scanner — the Scan tab's paste-syllabus-text screen, on iPhone, iPad, or the web, which accepts anywhere from 20 to 60,000 characters. It runs through the same extraction path a PDF does and lands on the same review screen."
        ]
      },
      {
        "heading": "What happens when a due date moves",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Not through the direct connection — Canvas, Blackboard, and Moodle import is a Pro feature, enforced on the server as well as in the interface. The free path is real, though: open your assignment list in Canvas, copy the text, and paste it into the scanner — the paste-syllabus-text screen on the Scan tab, available on iPhone, iPad, and the web, which accepts 20 to 60,000 characters. It runs the same extraction as a PDF and lands on the same review screen, where you confirm dates before anything is saved."
      },
      {
    ...
    "extraSections": [
      ...
      },
      {
        ...
        "body": [
          ...
          "Pro at $3.99/month or $19.99/year is where the rest lives: unlimited scans and courses, Canvas, Blackboard, and Moodle import, hosting your own Course Space, Smart Plan, the workload dashboard, flashcards, the focus timer, the AI tutor, grade scale and forecasting, device calendar sync with .ics export, 1-day and 3-day reminder timing with quiet hours, academic-risk alerts, and Progress Insights with CSV export and a print view on web. If you are on the free tier and your school uses Canvas, the real substitute for LMS import is the scanner's paste path on web: copy assignment text out of a Canvas page and paste it in, anywhere from 20 to 60,000 characters."
        ]
      },
      {
      ...
      },
      {
        ...
        "body": [
          ...
          "Third, can you get your data back out? In Semora that means CSV export and a print view for grade reports on the web, plus .ics export for deadlines, both on Pro. Fourth, does anything depend on your school? Semora's Canvas, Blackboard, and Moodle import uses a personal access token you generate yourself inside the LMS, so no administrator has to enable anything on their end, though that connection is a Pro feature, not a free one.",
    ...
    "extraSections": [
      ...
      },
      {
        ...
        "body": [
          ...
          "If you are on the free plan and your school uses Canvas, there is a real workaround worth knowing: open your Canvas assignments page, select the list, and paste it into the scanner on the web. You get the same extraction and the same review screen without the Pro LMS connection."
        ]
      },
      {
