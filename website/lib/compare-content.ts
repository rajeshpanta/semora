    ...
    "extraSections": [
      ...
      },
      {
        ...
        "body": [
          ...
          "On the free tier, the deadline and all of its reminders move with the edit. The study-plan rebuild, the calendar-event update, and the risk re-evaluation are Pro. Either way, the point is that one edit propagates rather than requiring a fresh scan, which also matters because on the free tier a re-scan would spend one of your five monthly scans."
        ]
      },
      {
        "heading": "What the free tier honestly covers for a full course load",
        "body": [
          "The free tier is 5 syllabus scans per calendar month and up to 4 courses, with no credit card. A standard four-course semester costs you four scans, which leaves one spare in the same month for the professor who hands out a revised syllabus in week two. The scan counter resets on the first of each month, and the course cap is counted separately from the scan cap. There is a third cap the arithmetic above hides, and it is the one worth knowing before you start: a free account covers one semester, total. The 5 scans a month and the 4 courses all live inside that single term, the limit is enforced both in the app and by a database trigger on the semesters table, and starting a second semester requires Pro. The 4-course cap does not roll over into a fresh term, because a free account never gets a fresh term.",
          "Re-scanning a course you already have does not consume a second course slot. Semora matches an incoming scan against your existing courses in that semester by course code at a word boundary, so \"CS 101\" matches your existing CS 101 and does not match CS 10, and folds the new deadlines into the course that is already there. That behavior is what makes the five-scan budget workable rather than tight.",
          "Free covers full deadline and task tracking, grade tracking with weighted averages against the letter scale the scan extracted, semester GPA, your class schedule, reminders 3 days / 1 day / morning-of, and joining a Course Space a classmate invites you to. Pro, at $3.99 per month or $19.99 per year — about $1.67 a month on the annual plan — adds unlimited courses and unlimited semesters, syllabus scanning with no monthly cap at all (a fair-use ceiling of 20 scans per day applies), LMS import subject to school policy and platform configuration, hosting your own Course Space, Smart Plan, the workload dashboard, flashcards, a focus timer, the AI tutor, grade scale customization and forecasting, device calendar sync with .ics export, per-task custom reminder timing with quiet hours, Academic Risk alerts, Progress Insights, and Share and Streaks. Pro is bought in the iOS app through StoreKit and applies account-wide, including on the web app; there is no web checkout.",
          "A permanently free product and a free tier under a paid product are different bets, and it is fair to weigh them as such. A free tier tells you how the paid version is funded and what happens if the developer needs revenue. A free product tells you nothing about that, favorably or unfavorably. With Semora the shape of the bet is unusually clear: free is one real term, with your real courses, and everything after that first semester is a paid decision. Make it on how the term actually went rather than on a feature list."
        ]
      },
      {
    ...
    "faq": [
      {
        ...
        "answer": "You edit the date on the deadline once and everything downstream follows. Semora cancels the old device reminders and reschedules them against the new date and time, updates the existing calendar event in place rather than creating a duplicate if device calendar sync is on, and rebuilds every unfinished Smart Plan study block the next time you open the planner, carrying missed sessions forward while keeping completed ones in your history. Calendar sync and Smart Plan are Pro; the deadline and all of its reminders move on the free tier."
      },
      {
        "question": "Do I need a separate scan for every course, and does re-scanning use up my free course limit?",
        "answer": "One scan handles one syllabus, so a four-course semester costs four of your five free monthly scans. Re-scanning a course you already have does not consume a second course slot: Semora matches the incoming scan against your existing courses by course code at a word boundary, so a revised CS 101 syllabus folds into the CS 101 you already have, and that re-scan leaves your meeting times, office hours and any grade-scale edits untouched, bringing through only the deadlines. Scans reset on the first of each calendar month, and the 5-scan cap and the 4-course cap are counted separately. The 4-course cap does not reset with a new term, though, because a free account is limited to one semester in total."
      },
      {
        "question": "Is Semora's free tier enough for a real semester, or is it a demo?",
        "answer": "It is a working tier rather than a timed sample, but it is scoped to one semester — free accounts are capped at a single semester total, so a second term needs Pro. Inside that term, free gives you 5 syllabus scans per month, up to 4 courses, full deadline and task tracking, grade tracking with weighted averages against the letter scale the scan extracted, semester GPA, your class schedule, reminders 3 days / 1 day / morning-of, and joining a Course Space a classmate invites you to. That is a genuine full course load, not a crippled preview. What it does not include is the study-planning layer: Smart Plan, the workload dashboard, flashcards, the focus timer, the AI tutor, grade forecasting, calendar sync, and per-task custom reminder timing are Pro."
      },
      {
  ...
  "mindgrasp": {
    "extraSections": [
      ...
      },
      {
        ...
        "body": [
          ...
          "Run the arithmetic against a normal semester anyway, because within that one term the free tier is genuinely usable. Four courses costs four of your five scans in the first week, which leaves one spare. The scan counter resets at the start of each calendar month, so a professor handing out a revised syllabus in week three draws on a fresh allowance rather than forcing an upgrade, and re-scanning a course you already have does not consume one of your four course slots. A fifth course does, and that is where Pro starts. You have four ways to feed the scanner: a camera photo of up to 5 pages per scan (budgeted at roughly 10 MB combined), a PDF upload, drag-and-drop on the web app, or raw text pasted into the web app, anywhere from 20 to 60,000 characters. On Pro the monthly scan cap goes away entirely and only a fair-use ceiling remains — 20 scans in a day, after which the parser asks you to come back tomorrow.",
          "One more limit worth stating plainly: Canvas, Blackboard, and Moodle import is a Pro feature, gated on the server, in the settings screen, and on the deep link. The current Canvas connector uses a personal access token and should be used only where your institution permits third-party token connections. If it is unavailable or not permitted, or you are on the free plan, open your Canvas assignments page, select the list, and paste it into the web scanner as text. You get the same extraction and the same review screen — you have simply done the fetching yourself."
        ]
      },
      {
      ...
      },
      {
        ...
        "body": [
          "Professors move dates, and that is where a planner either earns its place or becomes another thing to maintain. In Semora you change the due date once, on whichever device is in your hand, and everything derived from that date follows. Reminders for that task are cancelled and rebuilt — the standard 3-day, 1-day and morning-of set on every tier, plus per-task custom timing and quiet hours on Pro. The device calendar event refreshes if calendar sync is on; that sync is a Pro feature and it writes to the calendar on your iPhone or iPad, not inside a browser tab, though the .ics export downloads on the web just fine. The week scoring in the Pro workload view recomputes, which can move a crunch week or clear one.",
      ...
      },
      {
        ...
        "body": [
          ...
          "Semora's answers, for the record: every course lands in one deadline list; deadlines pass through an editable review screen with confidence and out-of-term warnings before they are saved; the free tier is exactly three numbers (5 scans per calendar month, 4 courses, and 1 semester per account) with nothing expiring on a date; Pro is $3.99 a month or $19.99 a year (about $1.67 a month on the annual plan), bought once in the iOS app through StoreKit and applied account-wide, with the web app reading and refreshing that entitlement rather than running a second checkout — there is no web checkout at all; and the gradebook uses the weights the scan pulled off your syllabus.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "At three numbers, not a date: 5 syllabus scans per calendar month, 4 courses, and 1 semester per account. The semester limit is the one to weigh first — it is enforced by a database trigger, not just a client check, so the four-course cap lives inside that single term rather than refilling each fall and spring. Everything inside those bounds keeps working: deadline and task tracking, weighted grades and semester GPA, advance reminders, and joining a Course Space someone invites you to. Pro ($3.99/month or $19.99/year) removes the course and semester limits and drops the monthly scan cap, leaving only a fair-use ceiling of 20 scans a day."
      },
      {
        "question": "What happens in Semora when a professor moves a due date?",
  ...
  "taskade": {
    "extraSections": [
      ...
      },
      {
        ...
        "body": [
          "Semora's free tier is $0 with no credit card and no time limit: 5 syllabus scans per calendar month, up to 4 courses, full deadline and task tracking, grade tracking with weighted averages, a current-semester GPA estimate, advance reminders, and joining any Course Space a classmate invites you to. One number matters more than the rest and it is the easiest to miss on a feature grid: a free account gets one semester, total, not one at a time.",
          "Run the math against an actual semester. Four courses is four scans, which leaves one spare for the professor who reissues a syllabus in week two. The scan window resets each calendar month, so a course you add in October does not draw down September's allowance. The course cap is written as four per semester, but because a free account only ever holds the one semester, four courses is the whole account. Where the free tier genuinely runs out, then, is a five-course term, a habit of re-scanning the same document to see whether the parse improves, and, the hard one, the next term. The free semester limit is one, checked in the app and again by a before-insert trigger on the semesters table, so starting a second semester is not a nag screen you can click past: the record is refused until you upgrade. Plan on one free semester and make the call in December rather than in September.",
      ...
      },
      {
        ...
        "body": [
          ...
          "Pricing shape is worth a look too, and it is where these two products stop being comparable. A team workspace prices around collaborators and seats (Taskade's own pricing page lists Pro at $10/month billed annually, Business at $25, and Max at $100) which is a reasonable structure for a company and an odd one for a single student. Semora Pro is $3.99/month or $19.99/year, which works out to about $1.67 a month annually. It is bought inside the iOS app through the App Store, there is no web checkout to go looking for, and the entitlement applies to your whole account, so the same login is Pro in the browser too.",
          "One last thing to budget honestly: assume you are paying from day one, and let the free tier carry you until you actually need something in Pro. There is no promo code to chase and nothing to buy on the website; the purchase happens on iPhone or iPad, and Restore Purchases re-attaches it if you change devices, while signing in on the web simply re-reads the entitlement your account already has. In practice the moment free stops being enough is specific and predictable: a fifth course, the first permitted LMS import you choose to use, hosting a Course Space instead of joining one, or the day you try to start your second semester."
        ]
      }
    ],
    "faq": [
      {
        ...
        "answer": "Editing the due date cancels the reminders already scheduled for that task and re-schedules them against the new date and time — advance reminders on every tier including free, and your per-task custom timing plus quiet hours if you are on Pro. If device calendar sync is on (Pro, on iPhone or iPad — it does not run in a browser), the existing calendar event is updated in place instead of duplicated, and the study blocks tied to that task are invalidated. Open Smart Plan (Pro) and it rebuilds from today forward, keeping completed sessions and carrying unfinished work along. The workload dashboard re-derives its crunch weeks from the new dates."
      },
      {
        "question": "Can I get Canvas assignments into Semora without paying?",
        "answer": "Not through the direct connection — Canvas, Blackboard, and Moodle import is a Pro feature, and the current Canvas connector uses a personal access token that should be used only where your institution permits it. The free path is real, though: open your assignment list in Canvas, copy the text, and paste it into the scanner on the web, which accepts 20 to 60,000 characters. It runs the same extraction as a PDF and lands on the same review screen, where you confirm dates before anything is saved."
      },
      {
        "question": "Is four courses enough on the free plan?",
        "answer": "For a single semester, usually yes: four courses plus five scans per calendar month covers a standard full-time load with one scan left over for a syllabus that gets reissued, and the scan allowance resets monthly, so adding a course later does not draw down an earlier month. The limit people actually hit is the other one — a free account supports one semester in total, enforced by a database trigger, so the free tier covers this term and not the next. You would also hit the ceiling on a five-course load or by re-scanning the same document repeatedly. Pro lifts all of it: unlimited courses, unlimited semesters, and no monthly scan cap, with a fair-use ceiling of 20 scans a day."
      },
      {
  ...
  "studley-ai": {
    "extraSections": [
      ...
      },
      {
        "heading": "What the free tier actually covers for a real course load",
        "body": [
          "Free is 5 syllabus scans per calendar month and up to 4 courses within one semester, with one semester total and no credit card. Run that against a normal load: four courses cost four scans, leaving one spare for the syllabus that gets revised in week two. A multi-page photo scan counts as one scan, not one per page, up to 5 pages and roughly 10 MB combined, so a dense four-page syllabus is still a single scan. Re-scanning a course you already created does not consume a new course slot either.",
          "Inside those limits the free tier is not a demo. You get the unified deadline list across every course, tasks and subtasks, weighted grade tracking against the letter scale your own syllabus specified, advance reminders, and the ability to join a Course Space a classmate invites you to. Joining a shared course is free and stays free; it is hosting one that requires Pro.",
          "Pro at $3.99/month or $19.99/year is where the rest lives: unlimited scans and courses, Canvas, Blackboard, and Moodle import, hosting your own Course Space, Smart Plan, the workload dashboard, flashcards, the focus timer, the AI tutor, grade scale and forecasting, device calendar sync with .ics export, per-task custom reminder timing with quiet hours, academic-risk alerts, and Progress Insights with CSV export and a print view on web. The current Canvas connector uses a personal access token and should be used only where the institution permits it. If it is unavailable or not permitted, or you are on the free tier, copy assignment text out of a Canvas page and paste it into the scanner on web, anywhere from 20 to 60,000 characters."
        ]
      },
      {
    ...
    "faq": [
      ...
      {
        "question": "Does a multi-page syllabus use up more than one of my five free scans?",
        "answer": "No. A photo scan can cover up to 5 pages and roughly 10 MB combined, and the whole thing counts as one scan against your monthly free allowance. The same holds for a PDF upload, a drag-and-drop on web, or pasted text. Re-scanning a course you already created also does not use a new course slot, so a syllabus corrected in week two costs you a scan but not a course."
      }
    ]
  },
  "myhomework": {
    "extraSections": [
      ...
      },
      {
        "heading": "What the free tier covers for a real course load",
        "body": [
          "Semora's free plan is not a countdown, but it does have a shape worth knowing before you commit. It gives you 5 syllabus scans per calendar month, resetting at the start of each month, and up to 4 courses — inside one semester. That last part is the boundary: a free account supports one semester total, not one per term. Everything inside that semester is generous. Tasks and deadlines are unlimited. Grade tracking with weighted averages is included, not held back , you enter scores and your course grade recalculates, and your semester GPA sits on the courses screen for free as well. Advance reminders are included. Joining a Course Space a classmate invites you to is free and always will be. No credit card is involved anywhere in that.",
          "Do the arithmetic against a real semester. A standard four-course load is four scans in the month you register, leaving one spare for the professor who posts a revised syllabus in week two, and re-scanning a course you already created does not consume a new course slot, so that path stays open even when you are sitting at the 4-course cap. What the free tier does not do is roll into a second term. Starting a new semester — spring after fall, or a summer session running alongside spring — requires Pro, and the limit is enforced by the database on insert, not just by the app, so there is no way to slip around it. Plan on the free tier as one full semester, start to finish, rather than as something you renew every August.",
          "What is genuinely gated, then, is the next semester and the automation layer. Pro at $3.99 a month or $19.99 a year makes courses and semesters unlimited and takes the monthly ceiling off scanning (there is still a fair-use limit of 20 scans in a day, which no normal course load comes near) and adds Canvas, Blackboard and Moodle import subject to school policy and platform configuration, hosting your own Course Space, Smart Plan, the Workload dashboard, Flashcards, a Focus timer, the AI Tutor, Grade Scale and Forecasting, device calendar sync with .ics export, custom reminder timing at 1 or 3 days out with quiet hours, Academic Risk alerts, Progress Insights, and Share and Streaks. Annual works out to about $1.67 a month, roughly 58% below monthly.",
          "Semora's current Canvas connector uses a personal access token you generate in Canvas. If you are on the free plan, or if your institution disables or prohibits third-party token use, open your Canvas assignments page, select the list, and paste it into the scanner on the web. You get the same extraction and the same review screen without the Pro LMS connection."
        ]
      },
      {
      ...
      },
      {
        ...
        "body": [
          ...
          "Then ask what the free plan actually is, and read where it stops rather than where it starts. Semora's is a full semester of real use (4 courses, 5 scans a month, unlimited tasks and deadlines, weighted grades and semester GPA) and it stops at the edge of that semester, because the second term needs Pro. Knowing the boundary up front is the difference between a plan and a surprise in January. Check the renewal price, not the first price, and check where the purchase lives. Semora Pro is bought inside the iOS app as an App Store subscription and applies account-wide, including on the web app — there is no separate web checkout, the web app reads and refreshes the entitlement, and you cancel through Apple's subscription settings like any other App Store subscription.",
    ...
    "faq": [
      ...
      {
        "question": "Is 5 scans a month really enough for a whole semester?",
        "answer": "For most students, yes. A four-course load costs four scans in the month you register, and the count resets at the start of each calendar month rather than being a lifetime allowance. Re-scanning a course you already have does not use a course slot, so a revised syllabus in week two is not a problem. The real free-tier boundary is not the scans — it is that a free account covers 4 courses within a single semester, and starting a second semester requires Pro. Pro removes the course and semester limits and the monthly scan cap, subject only to a fair-use ceiling of 20 scans in a day."
      },
      {
        "question": "Can I use Semora on a Windows laptop or an Android phone?",
        "answer": "Through the browser, yes. Semora is one universal iOS app for iPhone and iPad plus a full web app that runs in any modern browser on Windows, Mac, Chromebook or Android, all on one account with near real-time sync. What you do not get is a native desktop or Android client, and browser notifications only fire while a tab is open — device calendar sync is an app feature and does not run in a browser. Pro is purchased on iOS; the web app reads and refreshes that entitlement rather than selling its own."
      },
      {
