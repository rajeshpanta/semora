...
const CORE_PAGES: SpanishPageConfig[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Lo mismo ocurre con las funciones de Pro. Alojar un Espacio de curso se comprueba en el servidor y devuelve un error explícito, no solo un botón atenuado. La importación desde plataformas académicas ya no está en esa lista: es gratis en todos los planes.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'El plan Gratis incluye una acción de IA para toda la vida de la cuenta —un escaneo de programa, una grabación de clase o unos apuntes a partir de un documento, lo que necesites primero—, clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano dentro de un semestre, y un semestre en total, con seguimiento de entregas, calificaciones ponderadas y recordatorios el mismo día. No es una prueba que caduca.',
          'Pro cuesta 4,99 USD al mes o 29,99 USD al año, se compra con tarjeta en la web mediante Stripe o dentro de la app de iOS a través de la App Store, y se aplica a toda la cuenta, incluida la web. Se paga una sola vez: no hay una versión que haya que pagar dos veces.',
  ...
  page('/es/precios', '/pricing', 'pricing', {
    ...
    metaDescription: 'Empieza gratis. Semora Pro cuesta $4.99 al mes o $29.99 al año e incluye planificación, IA, LMS y herramientas avanzadas.',
    ...
    intro: [
      ...
      'Pro cuesta $4.99 al mes o $29.99 al año. Puedes contratarlo con tarjeta en la web o desde la app con tu Apple ID, y usarlo con la misma cuenta en iPhone, iPad y el navegador.',
    ],
    sections: [
      {
        ...
        bullets: [
          ...
          'Hasta clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano dentro de un semestre',
      ...
      },
      {
        ...
        paragraphs: [
          'Pro cuesta 4,99 USD al mes o 29,99 USD al año. El plan anual sale a unos 2,50 USD al mes, la mitad del precio mensual.',
        ...
        bullets: [
          '4,99 USD al mes o 29,99 USD al año (unos 2,50 USD al mes en el anual)',
  ...
  page('/es/funciones', '/features', 'features-index', {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'El precio es 4,99 $ al mes o 29,99 $ al año, que sale a unos 2,50 $ al mes y alrededor de un 50 % menos que pagando mes a mes. La compra ocurre con tarjeta en la web, donde cobra Stripe, o dentro de la app de iOS a través de StoreKit, y la suscripción se aplica a toda tu cuenta, incluida la app web. Pagues donde pagues no hay nada que activar después: la app y la web leen la misma suscripción.',
        ],
        bullets: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '4,99 USD al mes o 29,99 USD al año, que sale a unos 2,50 USD al mes en el plan anual. Se compra con tarjeta en la web, mediante Stripe, o en la app a través de la App Store; se gestiona desde Ajustes en Semora o desde tu Apple ID según cómo hayas pagado, y se aplica a toda tu cuenta.',
      },
    ],
  }),
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'El temporizador forma parte de Pro, a 4,99 USD al mes o 29,99 USD al año. La herramienta de esta página, en cambio, es gratuita y no necesita cuenta: úsala tal cual si lo único que buscas es una cuenta atrás decente.',
        ],
        bullets: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'En Semora los topes del plan Gratis son una acción de IA para toda la vida de la cuenta, clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano dentro de un semestre, y un semestre en total. El seguimiento de entregas y el motor de calificaciones ponderadas están completos y sin límite dentro de esos topes.',
        ],
      },
      {
...
const KEYWORD_PAGES: SpanishPageConfig[] = [
  page('/es/generador-de-tarjetas-con-ia', '/ai-flashcard-generator', 'standard', {
    ...
    faq: [
      ...
      { question: '¿El generador de tarjetas es gratis?', answer: 'No, forma parte de Pro, a 4,99 USD al mes o 29,99 USD al año. El plan Gratis cubre tu primer escaneo de programa, el seguimiento de entregas, las calificaciones ponderadas y los recordatorios el mismo día.' },
    ],
  }),
  page('/es/tutor-con-ia-para-universitarios', '/ai-tutor-for-college-students', 'standard', {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'El Tutor forma parte de Pro, a 4,99 USD al mes o 29,99 USD al año, comprado con tarjeta en la web o en la app de iOS y aplicado a toda la cuenta, incluida la web.',
        ],
        bullets: [
    ...
    faq: [
      ...
      { question: '¿El Tutor con IA es gratis?', answer: 'No, forma parte de Pro, a 4,99 USD al mes o 29,99 USD al año, comprado con tarjeta en la web o en la app de iOS y aplicado a toda tu cuenta, incluida la web.' },
    ],
  }),
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Pro elimina los tres por 4,99 USD al mes o 29,99 USD al año, comprado con tarjeta en la web o en la app de iOS y aplicado a toda la cuenta, web incluida. Pero si llevas cuatro materias o menos en un solo periodo y lo que necesitas es dejar de perder fechas y saber tu nota, el plan Gratis hace ese trabajo completo.',
        ],
      },
      {
  ...
  page('/es/seguimiento-de-tareas-de-blackboard', '/blackboard-assignment-tracker', 'standard', {
    ...
    metaDescription: 'Sigue el trabajo de Blackboard con recordatorios reales y notas ponderadas. Importación gratis donde tu institución la permita, o escaneo del programa.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'La importación desde Canvas, Blackboard y Moodle es gratis en todos los planes',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'El plan Gratis incluye una acción de IA para toda la vida de la cuenta —tu primer escaneo, por ejemplo—, clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano dentro de un semestre, un semestre en total, seguimiento completo de entregas, calificaciones ponderadas y recordatorios el mismo día.',
        ],
      },
      {
    ...
    faq: [
      { question: '¿La importación desde Blackboard es gratis?', answer: 'Sí. La importación desde plataformas académicas —Blackboard, Canvas y Moodle— es gratis en todos los planes. El plan Gratis cubre el mismo trabajo desde el programa, incluido pegar una lista de tareas de Blackboard en el escáner.' },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'El Plan inteligente forma parte de Pro, a 4,99 USD al mes o 29,99 USD al año, comprado con tarjeta en la web o dentro de la app de iOS y aplicado a toda la cuenta, incluida la web.',
        ],
      },
    ],
    faq: [
...
export const SPANISH_BLOG_INDEX_BODY: PageLongForm = {
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Los recordatorios el mismo día de Semora están activos por defecto en todos los planes, incluido el Gratis. Pro agrega avisos de uno o tres días de anticipación y horas de silencio. Conectar Canvas es un solo paso: copia el enlace privado del calendario que Canvas ya te da y pégalo. No hay ningún token que generar ni nada que tu universidad tenga que aprobar. La entrada cierra con una nota honesta: recordatorios más una mirada semanal al calendario, no recordatorios en lugar de esa mirada.',
      ],
      bullets: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Sí. Conectar Canvas, Blackboard o Moodle es gratis en todos los planes. De todos modos la ruta del plan Gratis es real, y la entrada sobre Canvas la explica: copia tu lista de tareas como texto y pégala directamente en el escáner de programas, que acepta texto pegado en la web desde veinte hasta sesenta mil caracteres.',
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Pro cuesta 4,99 USD al mes o 29,99 USD al año, que sale a unos 2,50 USD al mes en el plan anual. Se compra con tarjeta en la web, mediante Stripe, o dentro de la app de iOS a través de la App Store, y se aplica a toda tu cuenta pagues donde pagues: solo se paga una vez, no hay una versión de Semora que tengas que pagar dos veces.',

      ],
      bullets: [
        'Gratis: 1 acción de IA para toda la vida de la cuenta, hasta clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano dentro de un semestre, un semestre en total',
        'Gratis incluye fechas, tareas, calificaciones ponderadas y recordatorios el mismo día, completos',
        'Pro (4,99 USD al mes o 29,99 USD al año) elimina los tres topes y añade las herramientas de planificación y estudio',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Lo mismo vale para Canvas. Semora funciona solo con tu programa: la importación desde Canvas, Blackboard o Moodle es gratis y opcional, no un requisito. Conectar Canvas es un solo paso: copia el enlace privado del calendario que Canvas ya te da y pégalo. No hay ningún token que generar ni nada que tu universidad tenga que aprobar.',
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Los consejos de aprendizaje se presentan como métodos para probar, no como promesas universales. También indicamos los límites reales del producto: la cuenta gratuita cubre una acción de IA para toda la vida de la cuenta, clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano dentro de un solo semestre, y un semestre total. Cada entrega extraída se puede corregir y debe revisarse antes de añadirla al calendario.',
      ],
    },
  ],
  faq: [
...
const BLOG_PAGES: SpanishPageConfig[] = [
  page(SPANISH_BLOG_POSTS[0].path, SPANISH_BLOG_POSTS[0].englishPath, 'standard', {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'El plan Gratis incluye 1 acción de IA para toda la vida de la cuenta —un escaneo de programa, una grabación de clase o unos apuntes a partir de un documento—, clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano, y un semestre total, con seguimiento completo de entregas y calificaciones, además de recordatorios el mismo día. La sincronización con el calendario del dispositivo y la exportación .ics forman parte de Pro, que cuesta $4.99 al mes o $29.99 al año y se compra con tarjeta en la web o dentro de la app.',
    ...
    faq: [
      ...
      { question: '¿Necesito Pro para organizar el semestre así?', answer: 'No. Con el plan Gratis puedes escanear un programa —esa es la acción de IA que trae la cuenta, una para toda su vida— y llevar clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano en un semestre total, con seguimiento de entregas y calificaciones, además de recordatorios el mismo día. Una cuenta gratuita no puede iniciar un segundo periodo. Pro suma la sincronización con el calendario del dispositivo y la exportación .ics, y cuesta $4.99 al mes o $29.99 al año, con tarjeta en la web o dentro de la app.' },
    ],
  }),
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'El seguimiento de calificaciones viene en el plan Gratis, que incluye una acción de IA para toda la vida de la cuenta, clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano, y un semestre total.',
  ...
  page(SPANISH_BLOG_POSTS[3].path, SPANISH_BLOG_POSTS[3].englishPath, 'standard', {
    ...
    faq: [
      ...
      { question: '¿Necesito permiso de mi universidad para conectar Canvas?', answer: 'No. Conectar Canvas es un solo paso: copia el enlace privado del calendario que Canvas ya te da y pégalo. No hay ningún token que generar ni nada que tu universidad tenga que aprobar. Como es el mismo enlace que usarías para tu calendario, no depende de que tu universidad habilite nada.' },
      ...
      { question: '¿Cuántos cursos puedo llevar sin pagar?', answer: 'clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano, y un semestre total, con una acción de IA para toda la vida de la cuenta, seguimiento de tareas y calificaciones ponderadas, y recordatorios el mismo día. Una cuenta gratuita no puede iniciar un segundo periodo; Pro quita esos límites. El conector de Canvas con token personal es gratis, y debes usarlo solo si tu institución lo permite.' },
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ['Semora', 'Tu programa de clase: el documento se convierte en el semestre', 'Sí. Foto (hasta 5 páginas), PDF, arrastrar y soltar, o texto pegado', 'Sí, en el plan Gratis, con categorías ponderadas', 'Plan Gratis; Pro $4.99/mes o $29.99/año'],
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ['Semora', '1 acción de IA para toda la vida de la cuenta (un escaneo de programa, una grabación de clase o unos apuntes a partir de un documento), clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano, seguimiento completo de entregas y de calificaciones con promedios ponderados, recordatorios el mismo día y unirte a un curso que comparta un compañero', 'Esa acción de IA no se renueva, y es un curso a mano en un solo semestre (Canvas no cuenta y no tiene tope): una cuenta gratuita no puede abrir un segundo periodo'],
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ['Semora', 'Tu programa escaneado, los apuntes que subas y los paquetes de repaso adjuntos (PDF o foto), además de tarjetas manuales', 'Sí. Un mazo puede acotarse a todo el curso o a un examen o cuestionario concreto de tus entregas registradas', 'Sí', 'Pro: $4.99/mes o $29.99/año (el plan Gratis cubre entregas y calificaciones, no tarjetas)'],
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ['Semora', 'Sí, en el plan Gratis, con categorías ponderadas', 'Sí: Pro agrega escala de calificación y proyección, con calculadoras de escenarios para tu calificación final', 'Se extraen automáticamente del programa escaneado, junto con las fechas de entrega', 'Plan Gratis; Pro $4.99/mes o $29.99/año'],
...
function comparisonPage(item: (typeof SPANISH_COMPARISONS)[number]): SpanishPageConfig {
  return page(`/es/comparar/${item.slug}`, `/compare/${item.slug}`, 'standard', {
    ...
    faq: [
      ...
      { question: '¿Puedo probar Semora gratis?', answer: 'Sí. El plan Gratis no requiere tarjeta e incluye una acción de IA para toda la vida de la cuenta, clases ilimitadas sincronizadas gratis desde Canvas, Blackboard o Moodle, más un curso que añades a mano, y un semestre total, además de fechas de entrega y calificaciones.' },
    ],
  });
}
